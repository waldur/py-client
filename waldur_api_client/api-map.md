...
- `customers_components_usage_retrieve` GET `/api/customers/{uuid}/components-usage/` — Get customer resource usage statistics broken down per offering (path: uuid)
...
- `openportal_unmanaged_projects_components_usage_retrieve` GET `/api/openportal-unmanaged-projects/{uuid}/components-usage/` — Get project resource usage statistics broken down per offering (path: uuid)
...
- `projects_components_usage_retrieve` GET `/api/projects/{uuid}/components-usage/` — Get project resource usage statistics broken down per offering (path: uuid)
