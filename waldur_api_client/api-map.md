...
- `chat_threads_list` GET `/api/chat-threads/` (15 query params)
...
- `marketplace_offering_users_list` GET `/api/marketplace-offering-users/` — List offering users (18 query params)
- `marketplace_offering_users_count` HEAD `/api/marketplace-offering-users/` — List offering users (17 query params)
...
- `marketplace_stats_count_active_resources_grouped_by_offering_list` GET `/api/marketplace-stats/count_active_resources_grouped_by_offering/` — Count active resources grouped by offering (1 query param)
- `marketplace_stats_count_active_resources_grouped_by_offering_count` HEAD `/api/marketplace-stats/count_active_resources_grouped_by_offering/` — Get number of items in the collection matching the request parameters (1 query param)
