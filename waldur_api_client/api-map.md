...
- `marketplace_software_packages_list` GET `/api/marketplace-software-packages/` — List software packages (13 query params)
- `marketplace_software_packages_count` HEAD `/api/marketplace-software-packages/` — List software packages (13 query params)
