...
T = TypeVar("T", bound="CategoryHelpArticlesRequest")


@_attrs_define
class CategoryHelpArticlesRequest:
    """
    Attributes:
        url (str):
        categories (list['CategorySerializerForForNestedFieldsRequest']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category_help_articles_request = cls(
            url=url,
            categories=categories,
            title=title,
        )

        category_help_articles_request.additional_properties = d
        return category_help_articles_request
