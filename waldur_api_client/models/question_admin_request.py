...
if TYPE_CHECKING:
    from ..models.question_admin_request_allowed_file_types import QuestionAdminRequestAllowedFileTypes
    from ..models.question_admin_request_allowed_mime_types import QuestionAdminRequestAllowedMimeTypes
    from ..models.question_admin_request_guidance_answer_value_type_0 import (
        QuestionAdminRequestGuidanceAnswerValueType0,
    )
    from ..models.question_admin_request_review_answer_value_type_0 import QuestionAdminRequestReviewAnswerValueType0
...
class QuestionAdminRequest:
    ...
    Attributes:
        ...
        allowed_file_types (Union[Unset, QuestionAdminRequestAllowedFileTypes]): List of allowed file extensions (e.g.,
            ['.pdf', '.doc', '.docx']). If empty, all file types are allowed.
        allowed_mime_types (Union[Unset, QuestionAdminRequestAllowedMimeTypes]): List of allowed MIME types (e.g.,
        ...
        review_answer_value (Union['QuestionAdminRequestReviewAnswerValueType0', None, Unset]): Answer value that
            trigger review.
        always_requires_review (Union[Unset, bool]): This question always requires review regardless of answer
        guidance_answer_value (Union['QuestionAdminRequestGuidanceAnswerValueType0', None, Unset]): Answer value that
            triggers display of user guidance.
    ...
    allowed_file_types: Union[Unset, "QuestionAdminRequestAllowedFileTypes"] = UNSET
    allowed_mime_types: Union[Unset, "QuestionAdminRequestAllowedMimeTypes"] = UNSET
    ...
    review_answer_value: Union["QuestionAdminRequestReviewAnswerValueType0", None, Unset] = UNSET
    always_requires_review: Union[Unset, bool] = UNSET
    guidance_answer_value: Union["QuestionAdminRequestGuidanceAnswerValueType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.question_admin_request_review_answer_value_type_0 import (
        ...
        elif isinstance(self.review_answer_value, QuestionAdminRequestReviewAnswerValueType0):
        ...
        elif isinstance(self.guidance_answer_value, QuestionAdminRequestGuidanceAnswerValueType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allowed_file_types: Union[Unset, QuestionAdminRequestAllowedFileTypes]
        if isinstance(_allowed_file_types, Unset):
            allowed_file_types = UNSET
        else:
            allowed_file_types = QuestionAdminRequestAllowedFileTypes.from_dict(_allowed_file_types)

        _allowed_mime_types = d.pop("allowed_mime_types", UNSET)
        allowed_mime_types: Union[Unset, QuestionAdminRequestAllowedMimeTypes]
        if isinstance(_allowed_mime_types, Unset):
            allowed_mime_types = UNSET
        else:
            allowed_mime_types = QuestionAdminRequestAllowedMimeTypes.from_dict(_allowed_mime_types)
        ...
        def _parse_review_answer_value(
            data: object,
        ) -> Union["QuestionAdminRequestReviewAnswerValueType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                review_answer_value_type_0 = QuestionAdminRequestReviewAnswerValueType0.from_dict(data)

                return review_answer_value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["QuestionAdminRequestReviewAnswerValueType0", None, Unset], data)
        ...
        def _parse_guidance_answer_value(
            data: object,
        ) -> Union["QuestionAdminRequestGuidanceAnswerValueType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                guidance_answer_value_type_0 = QuestionAdminRequestGuidanceAnswerValueType0.from_dict(data)

                return guidance_answer_value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["QuestionAdminRequestGuidanceAnswerValueType0", None, Unset], data)
