...
T = TypeVar("T", bound="SilenceActionResponse")


@_attrs_define
class SilenceActionResponse:
    """
    Attributes:
        status (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        silence_action_response = cls(
            status=status,
            duration_days=duration_days,
        )

        silence_action_response.additional_properties = d
        return silence_action_response
