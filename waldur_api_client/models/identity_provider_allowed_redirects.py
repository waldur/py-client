...
T = TypeVar("T", bound="IdentityProviderAllowedRedirects")


@_attrs_define
class IdentityProviderAllowedRedirects:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        identity_provider_allowed_redirects = cls()

        identity_provider_allowed_redirects.additional_properties = d
        return identity_provider_allowed_redirects
