...
T = TypeVar("T", bound="ArticleCodeUpdatePreviewRequest")


@_attrs_define
class ArticleCodeUpdatePreviewRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        article_code_update_preview_request = cls(
            search=search,
            replace=replace,
        ...
        article_code_update_preview_request.additional_properties = d
        return article_code_update_preview_request
