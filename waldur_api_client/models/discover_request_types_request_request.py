...
T = TypeVar("T", bound="DiscoverRequestTypesRequestRequest")
...
class DiscoverRequestTypesRequestRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_request_types_request_request.additional_properties = d
        return discover_request_types_request_request
