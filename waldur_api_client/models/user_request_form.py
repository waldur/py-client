...
if TYPE_CHECKING:
    from ..models.user_request_form_eduperson_assurance import UserRequestFormEdupersonAssurance
    from ..models.user_request_form_managed_isds import UserRequestFormManagedIsds
    from ..models.user_request_form_nationalities import UserRequestFormNationalities
...
class UserRequestForm:
    ...
    Attributes:
        ...
        nationalities (Union[Unset, UserRequestFormNationalities]): List of all citizenships (ISO 3166-1 alpha-2 codes)
        ...
        eduperson_assurance (Union[Unset, UserRequestFormEdupersonAssurance]): REFEDS assurance profile URIs from
            identity provider
        ...
        managed_isds (Union[Unset, UserRequestFormManagedIsds]): List of ISD source identifiers this user can manage via
            Identity Bridge. E.g., ['isd:puhuri', 'isd:fenix']. Non-empty list implies identity manager role.
    ...
    nationalities: Union[Unset, "UserRequestFormNationalities"] = UNSET
    ...
    eduperson_assurance: Union[Unset, "UserRequestFormEdupersonAssurance"] = UNSET
    is_identity_manager: Union[Unset, bool] = UNSET
    can_use_personal_access_tokens: Union[Unset, bool] = UNSET
    managed_isds: Union[Unset, "UserRequestFormManagedIsds"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nationalities: Union[Unset, UserRequestFormNationalities]
        if isinstance(_nationalities, Unset):
            nationalities = UNSET
        else:
            nationalities = UserRequestFormNationalities.from_dict(_nationalities)
        ...
        eduperson_assurance: Union[Unset, UserRequestFormEdupersonAssurance]
        if isinstance(_eduperson_assurance, Unset):
            eduperson_assurance = UNSET
        else:
            eduperson_assurance = UserRequestFormEdupersonAssurance.from_dict(_eduperson_assurance)
        ...
        managed_isds: Union[Unset, UserRequestFormManagedIsds]
        if isinstance(_managed_isds, Unset):
            managed_isds = UNSET
        else:
            managed_isds = UserRequestFormManagedIsds.from_dict(_managed_isds)
