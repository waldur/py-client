...
T = TypeVar("T", bound="ResourceEndDateRequest")


@_attrs_define
class ResourceEndDateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_end_date_request = cls(
            end_date=end_date,
        )

        resource_end_date_request.additional_properties = d
        return resource_end_date_request
