...
T = TypeVar("T", bound="PatchedReviewerExpertiseRequest")


@_attrs_define
class PatchedReviewerExpertiseRequest:
    """
    Attributes:
        expertise_keyword (Union[Unset, str]): Free-text keyword
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if expertise_keyword is not UNSET:
            field_dict["expertise_keyword"] = expertise_keyword
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        expertise_keyword = d.pop("expertise_keyword", UNSET)
        ...
        patched_reviewer_expertise_request = cls(
        ...
        patched_reviewer_expertise_request.additional_properties = d
        return patched_reviewer_expertise_request
