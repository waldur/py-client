...
T = TypeVar("T", bound="DiscoverInstanceAvailabilityZonesRequestRequest")


@_attrs_define
class DiscoverInstanceAvailabilityZonesRequestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_instance_availability_zones_request_request = cls(
            auth_url=auth_url,
            username=username,
            password=password,
        ...
        discover_instance_availability_zones_request_request.additional_properties = d
        return discover_instance_availability_zones_request_request
