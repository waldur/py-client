...
T = TypeVar("T", bound="ArrowCustomerMappingCreate")


@_attrs_define
class ArrowCustomerMappingCreate:
    """
    Attributes:
        uuid (UUID):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arrow_customer_mapping_create = cls(
            uuid=uuid,
            url=url,
            settings=settings,
            settings_uuid=settings_uuid,
        ...
        arrow_customer_mapping_create.additional_properties = d
        return arrow_customer_mapping_create
