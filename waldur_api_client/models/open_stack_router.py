...
class OpenStackRouter:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.marketplace_offering_plugin_options, OpenStackRouterMarketplaceOfferingPluginOptionsType0):
        ...
        if isinstance(self.offering_external_ips, Unset):
            offering_external_ips = UNSET
        elif isinstance(self.offering_external_ips, list):
        ...
        if offering_external_ips is not UNSET:
            field_dict["offering_external_ips"] = offering_external_ips
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackRouterMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackRouterMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackRouterMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        offering_external_ips = _parse_offering_external_ips(d.pop("offering_external_ips", UNSET))
