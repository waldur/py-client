...
T = TypeVar("T", bound="ProviderOfferingDetailsBillingModeComponents")


@_attrs_define
class ProviderOfferingDetailsBillingModeComponents:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        provider_offering_details_billing_mode_components = cls()
        ...
        provider_offering_details_billing_mode_components.additional_properties = additional_properties
        return provider_offering_details_billing_mode_components
