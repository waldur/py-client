...
class ProjectRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        end_date_requested_by: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.end_date_requested_by, Unset):
            end_date_requested_by = UNSET
        elif isinstance(self.end_date_requested_by, str):
            end_date_requested_by = (None, str(self.end_date_requested_by).encode(), "text/plain")
        else:
            end_date_requested_by = (None, str(self.end_date_requested_by).encode(), "text/plain")
        ...
        is_industry = (
            self.is_industry
            if isinstance(self.is_industry, Unset)
            else (None, str(self.is_industry).encode(), "text/plain")
        )
