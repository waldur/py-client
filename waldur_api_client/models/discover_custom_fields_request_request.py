...
T = TypeVar("T", bound="DiscoverCustomFieldsRequestRequest")


@_attrs_define
class DiscoverCustomFieldsRequestRequest:
    """
    Attributes:
        ...
        request_type_id (Union[Unset, str]): Optional: Filter fields by request type
    """
    ...
    request_type_id: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_type_id = d.pop("request_type_id", UNSET)

        discover_custom_fields_request_request = cls(
            api_url=api_url,
            auth_method=auth_method,
            email=email,
            token=token,
        ...
        discover_custom_fields_request_request.additional_properties = d
        return discover_custom_fields_request_request
