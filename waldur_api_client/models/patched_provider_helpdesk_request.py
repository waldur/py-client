...
if TYPE_CHECKING:
    from ..models.patched_provider_helpdesk_request_settings import PatchedProviderHelpdeskRequestSettings


T = TypeVar("T", bound="PatchedProviderHelpdeskRequest")


@_attrs_define
class PatchedProviderHelpdeskRequest:
    """
    Attributes:
        service_provider (Union[Unset, UUID]):
        backend_type (Union[Unset, BackendTypeEnum]):
        settings (Union[Unset, PatchedProviderHelpdeskRequestSettings]): Backend-specific configuration.
    ...
    service_provider: Union[Unset, UUID] = UNSET
    backend_type: Union[Unset, BackendTypeEnum] = UNSET
    settings: Union[Unset, "PatchedProviderHelpdeskRequestSettings"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _service_provider = d.pop("service_provider", UNSET)
        service_provider: Union[Unset, UUID]
        if isinstance(_service_provider, Unset):
            service_provider = UNSET
        else:
            service_provider = UUID(_service_provider)
        ...
        settings: Union[Unset, PatchedProviderHelpdeskRequestSettings]
        if isinstance(_settings, Unset):
            settings = UNSET
        else:
            settings = PatchedProviderHelpdeskRequestSettings.from_dict(_settings)
        ...
        patched_provider_helpdesk_request = cls(
        ...
        patched_provider_helpdesk_request.additional_properties = d
        return patched_provider_helpdesk_request
