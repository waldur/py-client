...
T = TypeVar("T", bound="EventSubscriptionObservableObject")


@_attrs_define
class EventSubscriptionObservableObject:
    """
    Attributes:
        object_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_subscription_observable_object = cls(
            object_type=object_type,
            offering_uuid=offering_uuid,
            object_id=object_id,
        )

        event_subscription_observable_object.additional_properties = d
        return event_subscription_observable_object
