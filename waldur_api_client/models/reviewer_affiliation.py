...
T = TypeVar("T", bound="ReviewerAffiliation")
...
class ReviewerAffiliation:
    ...
    Attributes:
        ...
        organization_name_display (str): Return organization name from linked Customer or from the text field.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        organization_name_display = self.organization_name_display
        ...
        field_dict.update(
            {
                ...
                "organization_name_display": organization_name_display,
                "created": created,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_name_display = d.pop("organization_name_display")
        ...
        reviewer_affiliation.additional_properties = d
        return reviewer_affiliation
