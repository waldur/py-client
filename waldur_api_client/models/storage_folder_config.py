...
if TYPE_CHECKING:
    from ..models.storage_data_type import StorageDataType


T = TypeVar("T", bound="StorageFolderConfig")
...
class StorageFolderConfig:
    ...
    Attributes:
        component_type (str):
        storage_data_types (list['StorageDataType']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for storage_data_types_item_data in _storage_data_types:
            storage_data_types_item = StorageDataType.from_dict(storage_data_types_item_data)
        ...
        storage_folder_config.additional_properties = d
        return storage_folder_config
