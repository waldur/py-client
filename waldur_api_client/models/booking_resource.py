...
class BookingResource:
    ...
    Attributes:
        ...
        attributes (BookingResourceAttributes):
        limits (BookingResourceLimits):
        uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attributes = BookingResourceAttributes.from_dict(d.pop("attributes"))

        limits = BookingResourceLimits.from_dict(d.pop("limits"))
        ...
        current_usages = BookingResourceCurrentUsages.from_dict(d.pop("current_usages"))
