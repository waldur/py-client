...
T = TypeVar("T", bound="PatchedOrderAttachmentRequest")


@_attrs_define
class PatchedOrderAttachmentRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_order_attachment_request = cls(
            attachment=attachment,
        )

        patched_order_attachment_request.additional_properties = d
        return patched_order_attachment_request
