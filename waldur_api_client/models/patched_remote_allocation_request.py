...
T = TypeVar("T", bound="PatchedRemoteAllocationRequest")


@_attrs_define
class PatchedRemoteAllocationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_remote_allocation_request = cls(
            name=name,
        ...
        patched_remote_allocation_request.additional_properties = d
        return patched_remote_allocation_request
