...
if TYPE_CHECKING:
    from ..models.patched_reviewer_profile_request_alternative_names import (
...
class PatchedReviewerProfileRequest:
    ...
    Attributes:
        ...
        alternative_names (Union[Unset, PatchedReviewerProfileRequestAlternativeNames]): List of name variants used in
            publications
    ...
    alternative_names: Union[Unset, "PatchedReviewerProfileRequestAlternativeNames"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alternative_names: Union[Unset, PatchedReviewerProfileRequestAlternativeNames]
        if isinstance(_alternative_names, Unset):
            alternative_names = UNSET
        else:
            alternative_names = PatchedReviewerProfileRequestAlternativeNames.from_dict(_alternative_names)
