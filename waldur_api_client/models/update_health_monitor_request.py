...
T = TypeVar("T", bound="UpdateHealthMonitorRequest")
...
class UpdateHealthMonitorRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_health_monitor_request = cls(
            name=name,
            delay=delay,
            timeout=timeout,
        ...
        update_health_monitor_request.additional_properties = d
        return update_health_monitor_request
