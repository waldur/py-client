...
T = TypeVar("T", bound="PatchedPosixIdPoolRequest")


@_attrs_define
class PatchedPosixIdPoolRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_posix_id_pool_request = cls(
        ...
        patched_posix_id_pool_request.additional_properties = d
        return patched_posix_id_pool_request
