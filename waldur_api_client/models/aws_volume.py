...
class AwsVolume:
    ...
    Attributes:
        ...
        size (Union[Unset, int]): Size of volume in gigabytes
        volume_type (Union[Unset, VolumeTypeEnum]):
    ...
    volume_type: Union[Unset, VolumeTypeEnum] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_volume_type, Unset):
            ...
            volume_type = VolumeTypeEnum(_volume_type)
