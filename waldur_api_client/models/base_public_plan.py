...
T = TypeVar("T", bound="BasePublicPlan")


@_attrs_define
class BasePublicPlan:
    """
    Attributes:
        url (str):
        uuid (UUID):
        ...
        prices (BasePublicPlanPrices):
        future_prices (BasePublicPlanFuturePrices):
        quotas (BasePublicPlanQuotas):
        resources_count (int):
        plan_type (str):
        minimal_price (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prices = BasePublicPlanPrices.from_dict(d.pop("prices"))

        future_prices = BasePublicPlanFuturePrices.from_dict(d.pop("future_prices"))

        quotas = BasePublicPlanQuotas.from_dict(d.pop("quotas"))
        ...
        base_public_plan.additional_properties = d
        return base_public_plan
