...
T = TypeVar("T", bound="PatchedAssignmentBatchRequest")


@_attrs_define
class PatchedAssignmentBatchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_assignment_batch_request = cls(
            manager_notes=manager_notes,
        )

        patched_assignment_batch_request.additional_properties = d
        return patched_assignment_batch_request
