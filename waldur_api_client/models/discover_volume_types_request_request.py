...
@_attrs_define
class DiscoverVolumeTypesRequestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_volume_types_request_request = cls(
            auth_url=auth_url,
            username=username,
            password=password,
        ...
        discover_volume_types_request_request.additional_properties = d
        return discover_volume_types_request_request
