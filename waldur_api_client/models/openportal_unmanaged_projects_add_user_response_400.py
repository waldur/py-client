...
T = TypeVar("T", bound="OpenportalUnmanagedProjectsAddUserResponse400")


@_attrs_define
class OpenportalUnmanagedProjectsAddUserResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openportal_unmanaged_projects_add_user_response_400 = cls(
            non_field_errors=non_field_errors,
        )

        openportal_unmanaged_projects_add_user_response_400.additional_properties = d
        return openportal_unmanaged_projects_add_user_response_400
