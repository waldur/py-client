...
T = TypeVar("T", bound="ArrowSettingsRequest")


@_attrs_define
class ArrowSettingsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arrow_settings_request.additional_properties = d
        return arrow_settings_request
