...
T = TypeVar("T", bound="RequestedResourcePurchaseOrderRequest")


@_attrs_define
class RequestedResourcePurchaseOrderRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requested_resource_purchase_order_request = cls(
            attachment=attachment,
            purchase_order_reference=purchase_order_reference,
        )

        requested_resource_purchase_order_request.additional_properties = d
        return requested_resource_purchase_order_request
