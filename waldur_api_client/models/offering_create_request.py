...
if TYPE_CHECKING:
    ...
    from ..models.offering_create_request_attributes import OfferingCreateRequestAttributes
    from ..models.offering_create_request_backend_id_rules import OfferingCreateRequestBackendIdRules
    from ..models.offering_create_request_backend_metadata import OfferingCreateRequestBackendMetadata
...
class OfferingCreateRequest:
    ...
    Attributes:
        ...
        attributes (Union[Unset, OfferingCreateRequestAttributes]):
        ...
        backend_id_rules (Union[Unset, OfferingCreateRequestBackendIdRules]): Validation rules for resource backend_id:
            format regex and uniqueness scope.
        image (Union[File, None, Unset]):
        backend_metadata (Union[Unset, OfferingCreateRequestBackendMetadata]):
    ...
    attributes: Union[Unset, "OfferingCreateRequestAttributes"] = UNSET
    ...
    backend_id_rules: Union[Unset, "OfferingCreateRequestBackendIdRules"] = UNSET
    image: Union[File, None, Unset] = UNSET
    backend_metadata: Union[Unset, "OfferingCreateRequestBackendMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = OfferingCreateRequestAttributes.from_dict(_attributes)
        ...
        backend_id_rules: Union[Unset, OfferingCreateRequestBackendIdRules]
        if isinstance(_backend_id_rules, Unset):
            backend_id_rules = UNSET
        else:
            backend_id_rules = OfferingCreateRequestBackendIdRules.from_dict(_backend_id_rules)
        ...
        if isinstance(_backend_metadata, Unset):
            ...
            backend_metadata = OfferingCreateRequestBackendMetadata.from_dict(_backend_metadata)
