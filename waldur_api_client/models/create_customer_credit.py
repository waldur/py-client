...
T = TypeVar("T", bound="CreateCustomerCredit")


@_attrs_define
class CreateCustomerCredit:
    """
    Attributes:
        uuid (UUID):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_customer_credit.additional_properties = d
        return create_customer_credit
