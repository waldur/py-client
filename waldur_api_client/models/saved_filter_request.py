...
if TYPE_CHECKING:
    from ..models.saved_filter_request_filter_params import SavedFilterRequestFilterParams
...
class SavedFilterRequest:
    ...
    Attributes:
        name (str):
        filter_params (Union[Unset, SavedFilterRequestFilterParams]): Saved filter parameters as JSON.
        is_shared (Union[Unset, bool]): If True, visible to all staff/support users.
    """

    name: str
    filter_params: Union[Unset, "SavedFilterRequestFilterParams"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_params: Union[Unset, SavedFilterRequestFilterParams]
        if isinstance(_filter_params, Unset):
            filter_params = UNSET
        else:
            filter_params = SavedFilterRequestFilterParams.from_dict(_filter_params)
