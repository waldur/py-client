...
T = TypeVar("T", bound="PatchedOfferingUserServiceProviderCommentRequest")


@_attrs_define
class PatchedOfferingUserServiceProviderCommentRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_offering_user_service_provider_comment_request = cls(
            service_provider_comment=service_provider_comment,
            service_provider_comment_url=service_provider_comment_url,
        )

        patched_offering_user_service_provider_comment_request.additional_properties = d
        return patched_offering_user_service_provider_comment_request
