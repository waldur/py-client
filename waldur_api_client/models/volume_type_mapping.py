...
T = TypeVar("T", bound="VolumeTypeMapping")


@_attrs_define
class VolumeTypeMapping:
    """
    Attributes:
        src_type_uuid (UUID):
        dst_type_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        volume_type_mapping = cls(
            src_type_uuid=src_type_uuid,
            dst_type_uuid=dst_type_uuid,
        )

        volume_type_mapping.additional_properties = d
        return volume_type_mapping
