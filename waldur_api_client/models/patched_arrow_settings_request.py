...
T = TypeVar("T", bound="PatchedArrowSettingsRequest")


@_attrs_define
class PatchedArrowSettingsRequest:
    """
    Attributes:
        api_url (Union[Unset, str]): Arrow API base URL
        api_key (Union[Unset, str]): Arrow API Key (leave empty on update to keep current)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_arrow_settings_request = cls(
            api_url=api_url,
            api_key=api_key,
        ...
        patched_arrow_settings_request.additional_properties = d
        return patched_arrow_settings_request
