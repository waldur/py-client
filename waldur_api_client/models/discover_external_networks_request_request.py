...
T = TypeVar("T", bound="DiscoverExternalNetworksRequestRequest")


@_attrs_define
class DiscoverExternalNetworksRequestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_external_networks_request_request = cls(
            auth_url=auth_url,
            username=username,
            password=password,
        ...
        discover_external_networks_request_request.additional_properties = d
        return discover_external_networks_request_request
