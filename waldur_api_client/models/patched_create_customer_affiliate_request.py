...
T = TypeVar("T", bound="PatchedCreateCustomerAffiliateRequest")


@_attrs_define
class PatchedCreateCustomerAffiliateRequest:
    """
    Attributes:
        customer (Union[Unset, str]):
        affiliate (Union[Unset, str]):
    ...
    affiliate: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if affiliate is not UNSET:
            field_dict["affiliate"] = affiliate
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affiliate = d.pop("affiliate", UNSET)
        ...
        patched_create_customer_affiliate_request = cls(
            customer=customer,
            affiliate=affiliate,
        ...
        patched_create_customer_affiliate_request.additional_properties = d
        return patched_create_customer_affiliate_request
