...
if TYPE_CHECKING:
    from ..models.patched_customer_request_user_affiliations import PatchedCustomerRequestUserAffiliations
    from ..models.patched_customer_request_user_email_patterns import PatchedCustomerRequestUserEmailPatterns
    from ..models.patched_customer_request_user_identity_sources import PatchedCustomerRequestUserIdentitySources
...
class PatchedCustomerRequest:
    ...
    Attributes:
        ...
        grace_period_days (Union[None, Unset, int]): Number of extra days after project end date before resources are
            terminated
        user_email_patterns (Union[Unset, PatchedCustomerRequestUserEmailPatterns]):
        user_affiliations (Union[Unset, PatchedCustomerRequestUserAffiliations]):
        user_identity_sources (Union[Unset, PatchedCustomerRequestUserIdentitySources]): List of allowed identity
    ...
    user_email_patterns: Union[Unset, "PatchedCustomerRequestUserEmailPatterns"] = UNSET
    user_affiliations: Union[Unset, "PatchedCustomerRequestUserAffiliations"] = UNSET
    user_identity_sources: Union[Unset, "PatchedCustomerRequestUserIdentitySources"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user_email_patterns, Unset):
            ...
            user_email_patterns = PatchedCustomerRequestUserEmailPatterns.from_dict(_user_email_patterns)
        ...
        if isinstance(_user_affiliations, Unset):
            ...
            user_affiliations = PatchedCustomerRequestUserAffiliations.from_dict(_user_affiliations)

        _user_identity_sources = d.pop("user_identity_sources", UNSET)
        user_identity_sources: Union[Unset, PatchedCustomerRequestUserIdentitySources]
        if isinstance(_user_identity_sources, Unset):
            user_identity_sources = UNSET
        else:
            user_identity_sources = PatchedCustomerRequestUserIdentitySources.from_dict(_user_identity_sources)
