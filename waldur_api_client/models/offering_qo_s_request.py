...
T = TypeVar("T", bound="OfferingQoSRequest")


@_attrs_define
class OfferingQoSRequest:
    """
    Attributes:
        offering (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        offering_qo_s_request.additional_properties = d
        return offering_qo_s_request
