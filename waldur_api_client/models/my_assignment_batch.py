...
T = TypeVar("T", bound="MyAssignmentBatch")


@_attrs_define
class MyAssignmentBatch:
    """
    Attributes:
        uuid (UUID):
        call_uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_assignment_batch.additional_properties = d
        return my_assignment_batch
