...
if TYPE_CHECKING:
    from ..models.project_usage_entry import ProjectUsageEntry


T = TypeVar("T", bound="OfferingUsageByProject")


@_attrs_define
class OfferingUsageByProject:
    """
    Attributes:
        offering_uuid (UUID):
        offering_name (str):
        ...
        today (datetime.date):
        total_usage (float):
        projects (list['ProjectUsageEntry']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for projects_item_data in _projects:
            projects_item = ProjectUsageEntry.from_dict(projects_item_data)

            projects.append(projects_item)

        offering_usage_by_project = cls(
            offering_uuid=offering_uuid,
            offering_name=offering_name,
            type_=type_,
            name=name,
        ...
        offering_usage_by_project.additional_properties = d
        return offering_usage_by_project
