...
T = TypeVar("T", bound="ExportComponentData")


@_attrs_define
class ExportComponentData:
    """
    Attributes:
        type_ (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_component_data.additional_properties = d
        return export_component_data
