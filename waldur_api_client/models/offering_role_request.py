...
T = TypeVar("T", bound="OfferingRoleRequest")


@_attrs_define
class OfferingRoleRequest:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        offering_role_request.additional_properties = d
        return offering_role_request
