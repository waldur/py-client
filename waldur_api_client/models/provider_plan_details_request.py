...
T = TypeVar("T", bound="ProviderPlanDetailsRequest")


@_attrs_define
class ProviderPlanDetailsRequest:
    """
    Attributes:
        name (str):
        offering (str):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        max_amount: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.max_amount, Unset):
            max_amount = UNSET
        elif isinstance(self.max_amount, int):
            max_amount = (None, str(self.max_amount).encode(), "text/plain")
        else:
            max_amount = (None, str(self.max_amount).encode(), "text/plain")
        ...
        unit_price = (
            ...
            else (None, str(self.unit_price).encode(), "text/plain")
        )

        unit: Union[Unset, tuple[None, bytes, str]] = UNSET
        if not isinstance(self.unit, Unset):
            unit = (None, str(self.unit.value).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        provider_plan_details_request = cls(
            name=name,
            offering=offering,
        ...
        provider_plan_details_request.additional_properties = d
        return provider_plan_details_request
