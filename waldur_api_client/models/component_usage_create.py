...
T = TypeVar("T", bound="ComponentUsageCreate")


@_attrs_define
class ComponentUsageCreate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for usages_item_data in _usages:
            usages_item = ComponentUsageItem.from_dict(usages_item_data)
        ...
        component_usage_create = cls(
            usages=usages,
            plan_period=plan_period,
            resource=resource,
        )

        component_usage_create.additional_properties = d
        return component_usage_create
