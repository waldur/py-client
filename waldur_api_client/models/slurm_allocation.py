...
if TYPE_CHECKING:
    from ..models.slurm_allocation_marketplace_offering_plugin_options_type_0 import (
...
class SlurmAllocation:
    ...
    Attributes:
        ...
        cpu_limit (Union[Unset, int]):
        cpu_usage (Union[Unset, int]):
        gpu_limit (Union[Unset, int]):
        gpu_usage (Union[Unset, int]):
        ram_limit (Union[Unset, int]):
        ...
        marketplace_offering_plugin_options (Union['SlurmAllocationMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    cpu_limit: Union[Unset, int] = UNSET
    cpu_usage: Union[Unset, int] = UNSET
    gpu_limit: Union[Unset, int] = UNSET
    gpu_usage: Union[Unset, int] = UNSET
    ram_limit: Union[Unset, int] = UNSET
    ...
    marketplace_offering_plugin_options: Union["SlurmAllocationMarketplaceOfferingPluginOptionsType0", None, Unset] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.marketplace_offering_plugin_options, SlurmAllocationMarketplaceOfferingPluginOptionsType0):
        ...
        if gpu_limit is not UNSET:
            field_dict["gpu_limit"] = gpu_limit
        if gpu_usage is not UNSET:
            field_dict["gpu_usage"] = gpu_usage
        if ram_limit is not UNSET:
            field_dict["ram_limit"] = ram_limit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gpu_limit = d.pop("gpu_limit", UNSET)

        gpu_usage = d.pop("gpu_usage", UNSET)

        ram_limit = d.pop("ram_limit", UNSET)
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["SlurmAllocationMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    SlurmAllocationMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["SlurmAllocationMarketplaceOfferingPluginOptionsType0", None, Unset], data)
