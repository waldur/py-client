...
@_attrs_define
class PatchedMarketplaceCategoryRequest:
    """
    Attributes:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        default_vm_category = (
            self.default_vm_category
            if isinstance(self.default_vm_category, Unset)
            else (None, str(self.default_vm_category).encode(), "text/plain")
        )

        default_volume_category = (
            self.default_volume_category
            if isinstance(self.default_volume_category, Unset)
            else (None, str(self.default_volume_category).encode(), "text/plain")
        )

        default_tenant_category = (
            self.default_tenant_category
            if isinstance(self.default_tenant_category, Unset)
            else (None, str(self.default_tenant_category).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        patched_marketplace_category_request = cls(
            title=title,
        ...
        patched_marketplace_category_request.additional_properties = d
        return patched_marketplace_category_request
