...
T = TypeVar("T", bound="SramProjectRuleRequest")


@_attrs_define
class SramProjectRuleRequest:
    """
    Attributes:
        name (str):
        project_role (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sram_project_rule_request.additional_properties = d
        return sram_project_rule_request
