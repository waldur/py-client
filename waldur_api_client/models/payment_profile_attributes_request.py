...
T = TypeVar("T", bound="PaymentProfileAttributesRequest")


@_attrs_define
class PaymentProfileAttributesRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_profile_attributes_request = cls(
            end_date=end_date,
            agreement_number=agreement_number,
            contract_sum=contract_sum,
        )

        payment_profile_attributes_request.additional_properties = d
        return payment_profile_attributes_request
