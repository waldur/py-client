...
if TYPE_CHECKING:
    from ..models.open_stack_snapshot_marketplace_offering_plugin_options import (
...
class OpenStackSnapshot:
    ...
    Attributes:
        ...
        source_volume (Union[None, str]):
        size (int): Size in MiB
        runtime_state (str):
        source_volume_name (str):
        source_volume_marketplace_uuid (UUID):
        action (str):
        action_details (Any):
        restorations (list['OpenStackSnapshotRestoration']):
        marketplace_offering_uuid (str):
        marketplace_offering_name (str):
        marketplace_offering_plugin_options (OpenStackSnapshotMarketplaceOfferingPluginOptions):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_source_volume(data: object) -> Union[None, str]:
            if data is None:
                return data
            return cast(Union[None, str], data)

        source_volume = _parse_source_volume(d.pop("source_volume"))

        size = d.pop("size")

        runtime_state = d.pop("runtime_state")

        source_volume_name = d.pop("source_volume_name")

        source_volume_marketplace_uuid = UUID(d.pop("source_volume_marketplace_uuid"))
        ...
        marketplace_offering_plugin_options = OpenStackSnapshotMarketplaceOfferingPluginOptions.from_dict(
