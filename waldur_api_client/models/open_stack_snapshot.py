...
class OpenStackSnapshot:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union[Unset, OpenStackSnapshotMarketplaceOfferingPluginOptions]):
    ...
    marketplace_offering_plugin_options: Union[Unset, "OpenStackSnapshotMarketplaceOfferingPluginOptions"] = UNSET
