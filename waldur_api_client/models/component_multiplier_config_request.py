...
T = TypeVar("T", bound="ComponentMultiplierConfigRequest")


@_attrs_define
class ComponentMultiplierConfigRequest:
    """
    Attributes:
        component_type (str):
        factor (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        component_multiplier_config_request = cls(
            component_type=component_type,
            factor=factor,
            min_limit=min_limit,
            max_limit=max_limit,
        ...
        component_multiplier_config_request.additional_properties = d
        return component_multiplier_config_request
