...
T = TypeVar("T", bound="DiscoverFlavorsRequestRequest")


@_attrs_define
class DiscoverFlavorsRequestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_flavors_request_request = cls(
            auth_url=auth_url,
            username=username,
            password=password,
        ...
        discover_flavors_request_request.additional_properties = d
        return discover_flavors_request_request
