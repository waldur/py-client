...
T = TypeVar("T", bound="PatchedCallWorkflowStepRequest")


@_attrs_define
class PatchedCallWorkflowStepRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_call_workflow_step_request = cls(
        ...
        patched_call_workflow_step_request.additional_properties = d
        return patched_call_workflow_step_request
