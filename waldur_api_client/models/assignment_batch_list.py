...
T = TypeVar("T", bound="AssignmentBatchList")


@_attrs_define
class AssignmentBatchList:
    """
    Attributes:
        url (str):
        uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignment_batch_list.additional_properties = d
        return assignment_batch_list
