...
class RancherCluster:
    ...
    Attributes:
        ...
        node_command (str): Rancher generated node installation command base.
        nodes (list['RancherNestedNode']):
        tenant (str):
        tenant_uuid (UUID):
        runtime_state (str):
        management_security_group (str):
        marketplace_offering_uuid (str):
        marketplace_offering_name (str):
        marketplace_offering_plugin_options (RancherClusterMarketplaceOfferingPluginOptions):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        node_command = d.pop("node_command")
        ...
        management_security_group = d.pop("management_security_group")
