...
T = TypeVar("T", bound="OpenStackSecurityGroupRuleUpdateByNameRequest")


@_attrs_define
class OpenStackSecurityGroupRuleUpdateByNameRequest:
    """
    Attributes:
    ...
    remote_group: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remote_group = d.pop("remote_group", UNSET)

        open_stack_security_group_rule_update_by_name_request = cls(
            ethertype=ethertype,
            direction=direction,
            protocol=protocol,
            from_port=from_port,
        ...
        open_stack_security_group_rule_update_by_name_request.additional_properties = d
        return open_stack_security_group_rule_update_by_name_request
