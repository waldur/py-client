...
T = TypeVar("T", bound="NestedSectionRequest")


@_attrs_define
class NestedSectionRequest:
    """
    Attributes:
        key (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nested_section_request = cls(
            key=key,
            title=title,
            is_standalone=is_standalone,
        )

        nested_section_request.additional_properties = d
        return nested_section_request
