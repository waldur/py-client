...
T = TypeVar("T", bound="UpdateActionsResponse")


@_attrs_define
class UpdateActionsResponse:
    """
    Attributes:
        status (str):
        message (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_actions_response = cls(
            status=status,
            message=message,
            provider_action_type=provider_action_type,
        )

        update_actions_response.additional_properties = d
        return update_actions_response
