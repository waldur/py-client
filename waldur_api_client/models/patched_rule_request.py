...
if TYPE_CHECKING:
    ...
    from ..models.patched_rule_request_user_claims import PatchedRuleRequestUserClaims
...
class PatchedRuleRequest:
    ...
    Attributes:
        ...
        user_claims (Union[Unset, PatchedRuleRequestUserClaims]): Identity provider claims the user must carry, as
            {"claim": ["accepted", "values"]}. All claims must match; within one claim any value matches. A value ending in
            '*' matches by prefix.
    ...
    user_claims: Union[Unset, "PatchedRuleRequestUserClaims"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_claims: Union[Unset, PatchedRuleRequestUserClaims]
        if isinstance(_user_claims, Unset):
            user_claims = UNSET
        else:
            user_claims = PatchedRuleRequestUserClaims.from_dict(_user_claims)
