...
T = TypeVar("T", bound="OfferingGroupRequestMultipart")


@_attrs_define
class OfferingGroupRequestMultipart:
    """
    Attributes:
        title (str):
        customer (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        offering_group_request_multipart = cls(
            title=title,
            customer=customer,
        ...
        offering_group_request_multipart.additional_properties = d
        return offering_group_request_multipart
