...
if TYPE_CHECKING:
    from ..models.reviewer_profile_request_alternative_names import ReviewerProfileRequestAlternativeNames


T = TypeVar("T", bound="ReviewerProfileRequest")


@_attrs_define
class ReviewerProfileRequest:
    """
    Attributes:
        ...
        alternative_names (Union[Unset, ReviewerProfileRequestAlternativeNames]): List of name variants used in
            publications
    ...
    alternative_names: Union[Unset, "ReviewerProfileRequestAlternativeNames"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alternative_names: Union[Unset, ReviewerProfileRequestAlternativeNames]
        if isinstance(_alternative_names, Unset):
            alternative_names = UNSET
        else:
            alternative_names = ReviewerProfileRequestAlternativeNames.from_dict(_alternative_names)

        available_for_reviews = d.pop("available_for_reviews", UNSET)

        reviewer_profile_request = cls(
            orcid_id=orcid_id,
            biography=biography,
        ...
        reviewer_profile_request.additional_properties = d
        return reviewer_profile_request
