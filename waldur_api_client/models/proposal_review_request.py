...
T = TypeVar("T", bound="ProposalReviewRequest")
...
class ProposalReviewRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        proposal = (None, str(self.proposal).encode(), "text/plain")

        reviewer = (None, str(self.reviewer).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return proposal_review_request
