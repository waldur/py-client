...
T = TypeVar("T", bound="PatchedOfferingGroupRequest")


@_attrs_define
class PatchedOfferingGroupRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_offering_group_request = cls(
            title=title,
            description=description,
            icon=icon,
        )

        patched_offering_group_request.additional_properties = d
        return patched_offering_group_request
