...
T = TypeVar("T", bound="COIDisclosureFinancialInterestRequest")


@_attrs_define
class COIDisclosureFinancialInterestRequest:
    """
    Attributes:
        entity_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coi_disclosure_financial_interest_request = cls(
            entity_name=entity_name,
            entity_type=entity_type,
            relationship_type=relationship_type,
            amount_range=amount_range,
        ...
        coi_disclosure_financial_interest_request.additional_properties = d
        return coi_disclosure_financial_interest_request
