...
T = TypeVar("T", bound="PatchedUpdateListenerRequest")


@_attrs_define
class PatchedUpdateListenerRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_update_listener_request = cls(
            name=name,
            default_pool=default_pool,
        )

        patched_update_listener_request.additional_properties = d
        return patched_update_listener_request
