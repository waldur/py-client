...
T = TypeVar("T", bound="CallAssignmentConfigurationRequest")


@_attrs_define
class CallAssignmentConfigurationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        call_assignment_configuration_request = cls(
        ...
        call_assignment_configuration_request.additional_properties = d
        return call_assignment_configuration_request
