...
T = TypeVar("T", bound="ReviewerExpertiseRequest")


@_attrs_define
class ReviewerExpertiseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reviewer_expertise_request = cls(
            expertise_keyword=expertise_keyword,
        ...
        reviewer_expertise_request.additional_properties = d
        return reviewer_expertise_request
