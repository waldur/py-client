...
T = TypeVar("T", bound="OrderConsumerInfoRequestForm")


@_attrs_define
class OrderConsumerInfoRequestForm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order_consumer_info_request_form = cls(
            consumer_message=consumer_message,
            consumer_message_attachment=consumer_message_attachment,
        )

        order_consumer_info_request_form.additional_properties = d
        return order_consumer_info_request_form
