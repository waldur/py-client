...
if TYPE_CHECKING:
    from ..models.open_stack_pool_member_marketplace_offering_plugin_options_type_0 import (
        OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0,
    )


T = TypeVar("T", bound="OpenStackPoolMember")


@_attrs_define
class OpenStackPoolMember:
    """
    Attributes:
        url (Union[Unset, str]):
        ...
        marketplace_offering_plugin_options (Union['OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    marketplace_offering_plugin_options: Union[
        "OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0", None, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marketplace_offering_plugin_options, Unset):
            ...
            self.marketplace_offering_plugin_options, OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_address(data: object) -> Union[Unset, str]:
            if isinstance(data, Unset):
                return data
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackPoolMemberMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        open_stack_pool_member.additional_properties = d
        return open_stack_pool_member
