...
T = TypeVar("T", bound="OfferingBillingModeComponents")


@_attrs_define
class OfferingBillingModeComponents:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        offering_billing_mode_components = cls()
        ...
        offering_billing_mode_components.additional_properties = additional_properties
        return offering_billing_mode_components
