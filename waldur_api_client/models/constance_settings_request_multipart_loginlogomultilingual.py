...
T = TypeVar("T", bound="ConstanceSettingsRequestMultipartLOGINLOGOMULTILINGUAL")


@_attrs_define
class ConstanceSettingsRequestMultipartLOGINLOGOMULTILINGUAL:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        constance_settings_request_multipart_loginlogomultilingual = cls()
        ...
        constance_settings_request_multipart_loginlogomultilingual.additional_properties = additional_properties
        return constance_settings_request_multipart_loginlogomultilingual
