...
class QueryOutput:
    """
    Attributes:
        customers (Union[Unset, list['IdNamePair']]):
        offerings (Union[Unset, list['IdNamePair']]):
        all_users (Union[Unset, bool]):
    """

    customers: Union[Unset, list["IdNamePair"]] = UNSET
    offerings: Union[Unset, list["IdNamePair"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for customers_item_data in _customers or []:
            customers_item = IdNamePair.from_dict(customers_item_data)
        ...
        for offerings_item_data in _offerings or []:
            offerings_item = IdNamePair.from_dict(offerings_item_data)
