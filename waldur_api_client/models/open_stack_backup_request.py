...
T = TypeVar("T", bound="OpenStackBackupRequest")


@_attrs_define
class OpenStackBackupRequest:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_stack_backup_request = cls(
            name=name,
            description=description,
            kept_until=kept_until,
        )

        open_stack_backup_request.additional_properties = d
        return open_stack_backup_request
