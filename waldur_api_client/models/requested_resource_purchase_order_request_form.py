...
T = TypeVar("T", bound="RequestedResourcePurchaseOrderRequestForm")


@_attrs_define
class RequestedResourcePurchaseOrderRequestForm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requested_resource_purchase_order_request_form = cls(
            attachment=attachment,
            purchase_order_reference=purchase_order_reference,
        )

        requested_resource_purchase_order_request_form.additional_properties = d
        return requested_resource_purchase_order_request_form
