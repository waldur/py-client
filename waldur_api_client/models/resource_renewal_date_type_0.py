...
T = TypeVar("T", bound="ResourceRenewalDateType0")


@_attrs_define
class ResourceRenewalDateType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        resource_renewal_date_type_0 = cls()
        ...
        resource_renewal_date_type_0.additional_properties = additional_properties
        return resource_renewal_date_type_0
