...
T = TypeVar("T", bound="OrganizationGroupsRequest")


@_attrs_define
class OrganizationGroupsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_groups_request.additional_properties = d
        return organization_groups_request
