...
T = TypeVar("T", bound="ProjectInfoRequest")


@_attrs_define
class ProjectInfoRequest:
    """
    Attributes:
        project (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_info_request = cls(
            project=project,
            shortname=shortname,
            allowed_destinations=allowed_destinations,
        )

        project_info_request.additional_properties = d
        return project_info_request
