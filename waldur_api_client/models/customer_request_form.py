...
if TYPE_CHECKING:
    from ..models.customer_request_form_user_affiliations import CustomerRequestFormUserAffiliations
    from ..models.customer_request_form_user_email_patterns import CustomerRequestFormUserEmailPatterns
    from ..models.customer_request_form_user_identity_sources import CustomerRequestFormUserIdentitySources


T = TypeVar("T", bound="CustomerRequestForm")
...
class CustomerRequestForm:
    ...
    Attributes:
        ...
        grace_period_days (Union[None, Unset, int]): Number of extra days after project end date before resources are
            terminated
        user_email_patterns (Union[Unset, CustomerRequestFormUserEmailPatterns]):
        user_affiliations (Union[Unset, CustomerRequestFormUserAffiliations]):
        user_identity_sources (Union[Unset, CustomerRequestFormUserIdentitySources]): List of allowed identity sources
            (identity providers).
    ...
    user_email_patterns: Union[Unset, "CustomerRequestFormUserEmailPatterns"] = UNSET
    user_affiliations: Union[Unset, "CustomerRequestFormUserAffiliations"] = UNSET
    user_identity_sources: Union[Unset, "CustomerRequestFormUserIdentitySources"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user_email_patterns, Unset):
            ...
            user_email_patterns = CustomerRequestFormUserEmailPatterns.from_dict(_user_email_patterns)
        ...
        if isinstance(_user_affiliations, Unset):
            ...
            user_affiliations = CustomerRequestFormUserAffiliations.from_dict(_user_affiliations)

        _user_identity_sources = d.pop("user_identity_sources", UNSET)
        user_identity_sources: Union[Unset, CustomerRequestFormUserIdentitySources]
        if isinstance(_user_identity_sources, Unset):
            user_identity_sources = UNSET
        else:
            user_identity_sources = CustomerRequestFormUserIdentitySources.from_dict(_user_identity_sources)
