...
T = TypeVar("T", bound="ReviewerSuggestionTopMatchingProposalRequest")


@_attrs_define
class ReviewerSuggestionTopMatchingProposalRequest:
    """
    Attributes:
        uuid (UUID):
        affinity (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reviewer_suggestion_top_matching_proposal_request = cls(
            uuid=uuid,
            affinity=affinity,
            name=name,
            slug=slug,
        ...
        reviewer_suggestion_top_matching_proposal_request.additional_properties = d
        return reviewer_suggestion_top_matching_proposal_request
