...
T = TypeVar("T", bound="AzurePublicIP")
...
class AzurePublicIP:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (AzurePublicIPMarketplaceOfferingPluginOptions):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        azure_public_ip.additional_properties = d
