...
T = TypeVar("T", bound="CustomersAddUserResponse400")


@_attrs_define
class CustomersAddUserResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customers_add_user_response_400 = cls(
            non_field_errors=non_field_errors,
        )

        customers_add_user_response_400.additional_properties = d
        return customers_add_user_response_400
