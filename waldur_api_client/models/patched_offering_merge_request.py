...
if TYPE_CHECKING:
    from ..models.patched_offering_merge_request_attribute_key_mapping import (
        PatchedOfferingMergeRequestAttributeKeyMapping,
    )
    from ..models.patched_offering_merge_request_component_mapping import PatchedOfferingMergeRequestComponentMapping
    from ..models.patched_offering_merge_request_plan_mapping import PatchedOfferingMergeRequestPlanMapping


T = TypeVar("T", bound="PatchedOfferingMergeRequest")


@_attrs_define
class PatchedOfferingMergeRequest:
    """
    Attributes:
        sources (Union[Unset, list[UUID]]): Offerings whose resources and history move to the target.
        target (Union[Unset, UUID]):
        plan_mapping (Union[Unset, PatchedOfferingMergeRequestPlanMapping]): Source plan UUID to target plan UUID.
        component_mapping (Union[Unset, PatchedOfferingMergeRequestComponentMapping]): Per source offering UUID: source
            component type to target component type.
        attribute_key_mapping (Union[Unset, PatchedOfferingMergeRequestAttributeKeyMapping]): Order and resource answer
            key renames: old key to new key.
        invoice_policy (Union[Unset, InvoicePolicyEnum]):
    """

    sources: Union[Unset, list[UUID]] = UNSET
    target: Union[Unset, UUID] = UNSET
    plan_mapping: Union[Unset, "PatchedOfferingMergeRequestPlanMapping"] = UNSET
    component_mapping: Union[Unset, "PatchedOfferingMergeRequestComponentMapping"] = UNSET
    attribute_key_mapping: Union[Unset, "PatchedOfferingMergeRequestAttributeKeyMapping"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.patched_offering_merge_request_component_mapping import (
        ...
        plan_mapping: Union[Unset, PatchedOfferingMergeRequestPlanMapping]
        if isinstance(_plan_mapping, Unset):
            plan_mapping = UNSET
        else:
            plan_mapping = PatchedOfferingMergeRequestPlanMapping.from_dict(_plan_mapping)

        _component_mapping = d.pop("component_mapping", UNSET)
        component_mapping: Union[Unset, PatchedOfferingMergeRequestComponentMapping]
        if isinstance(_component_mapping, Unset):
            component_mapping = UNSET
        else:
            component_mapping = PatchedOfferingMergeRequestComponentMapping.from_dict(_component_mapping)

        _attribute_key_mapping = d.pop("attribute_key_mapping", UNSET)
        attribute_key_mapping: Union[Unset, PatchedOfferingMergeRequestAttributeKeyMapping]
        if isinstance(_attribute_key_mapping, Unset):
            attribute_key_mapping = UNSET
        else:
            attribute_key_mapping = PatchedOfferingMergeRequestAttributeKeyMapping.from_dict(_attribute_key_mapping)
        ...
        patched_offering_merge_request = cls(
            sources=sources,
            target=target,
        ...
        patched_offering_merge_request.additional_properties = d
        return patched_offering_merge_request
