...
if TYPE_CHECKING:
    ...
    from ..models.rancher_application_marketplace_offering_plugin_options_type_0 import (
...
class RancherApplication:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union['RancherApplicationMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    marketplace_offering_plugin_options: Union[
        "RancherApplicationMarketplaceOfferingPluginOptionsType0", None, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marketplace_offering_plugin_options, Unset):
            ...
            self.marketplace_offering_plugin_options, RancherApplicationMarketplaceOfferingPluginOptionsType0
        ):
        ...
        if rancher_project_name is not UNSET:
            field_dict["rancher_project_name"] = rancher_project_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rancher_project_name = d.pop("rancher_project_name", UNSET)
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["RancherApplicationMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    RancherApplicationMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["RancherApplicationMarketplaceOfferingPluginOptionsType0", None, Unset], data)
