...
if TYPE_CHECKING:
    from ..models.project_request_form_user_affiliations import ProjectRequestFormUserAffiliations
    from ..models.project_request_form_user_email_patterns import ProjectRequestFormUserEmailPatterns
    from ..models.project_request_form_user_identity_sources import ProjectRequestFormUserIdentitySources


T = TypeVar("T", bound="ProjectRequestForm")
...
class ProjectRequestForm:
    ...
    Attributes:
        ...
        user_email_patterns (Union[Unset, ProjectRequestFormUserEmailPatterns]):
        user_affiliations (Union[Unset, ProjectRequestFormUserAffiliations]):
        user_identity_sources (Union[Unset, ProjectRequestFormUserIdentitySources]): List of allowed identity sources
            (identity providers).
    ...
    user_email_patterns: Union[Unset, "ProjectRequestFormUserEmailPatterns"] = UNSET
    user_affiliations: Union[Unset, "ProjectRequestFormUserAffiliations"] = UNSET
    user_identity_sources: Union[Unset, "ProjectRequestFormUserIdentitySources"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user_email_patterns, Unset):
            ...
            user_email_patterns = ProjectRequestFormUserEmailPatterns.from_dict(_user_email_patterns)
        ...
        if isinstance(_user_affiliations, Unset):
            ...
            user_affiliations = ProjectRequestFormUserAffiliations.from_dict(_user_affiliations)

        _user_identity_sources = d.pop("user_identity_sources", UNSET)
        user_identity_sources: Union[Unset, ProjectRequestFormUserIdentitySources]
        if isinstance(_user_identity_sources, Unset):
            user_identity_sources = UNSET
        else:
            user_identity_sources = ProjectRequestFormUserIdentitySources.from_dict(_user_identity_sources)
