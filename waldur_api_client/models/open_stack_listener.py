...
if TYPE_CHECKING:
    from ..models.open_stack_listener_marketplace_offering_plugin_options_type_0 import (
        OpenStackListenerMarketplaceOfferingPluginOptionsType0,
    )


T = TypeVar("T", bound="OpenStackListener")


@_attrs_define
class OpenStackListener:
    """
    Attributes:
        url (Union[Unset, str]):
        ...
        backend_id (Union[None, Unset, str]): Listener ID in Octavia
        access_url (Union[None, Unset, str]):
        load_balancer (Union[Unset, str]): Load balancer this listener belongs to
        load_balancer_name (Union[Unset, str]):
        load_balancer_uuid (Union[Unset, UUID]):
        protocol (Union[Unset, str]):
        protocol_port (Union[Unset, int]):
        default_pool (Union[None, Unset, str]): Default pool for this listener
        ...
        marketplace_offering_plugin_options (Union['OpenStackListenerMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    load_balancer_name: Union[Unset, str] = UNSET
    ...
    marketplace_offering_plugin_options: Union[
        "OpenStackListenerMarketplaceOfferingPluginOptionsType0", None, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marketplace_offering_plugin_options, Unset):
            ...
            self.marketplace_offering_plugin_options, OpenStackListenerMarketplaceOfferingPluginOptionsType0
        ):
        ...
        if load_balancer_name is not UNSET:
            field_dict["load_balancer_name"] = load_balancer_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        load_balancer_name = d.pop("load_balancer_name", UNSET)
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackListenerMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackListenerMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackListenerMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        open_stack_listener.additional_properties = d
        return open_stack_listener
