...
T = TypeVar("T", bound="PatchedCallCOIConfigurationRequest")


@_attrs_define
class PatchedCallCOIConfigurationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_call_coi_configuration_request = cls(
        ...
        patched_call_coi_configuration_request.additional_properties = d
        return patched_call_coi_configuration_request
