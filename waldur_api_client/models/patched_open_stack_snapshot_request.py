...
@_attrs_define
class PatchedOpenStackSnapshotRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_open_stack_snapshot_request = cls(
            name=name,
        ...
        patched_open_stack_snapshot_request.additional_properties = d
        return patched_open_stack_snapshot_request
