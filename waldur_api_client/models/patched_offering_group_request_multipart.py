...
T = TypeVar("T", bound="PatchedOfferingGroupRequestMultipart")


@_attrs_define
class PatchedOfferingGroupRequestMultipart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_offering_group_request_multipart = cls(
            title=title,
            description=description,
            icon=icon,
        )

        patched_offering_group_request_multipart.additional_properties = d
        return patched_offering_group_request_multipart
