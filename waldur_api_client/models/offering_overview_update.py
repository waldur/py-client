...
T = TypeVar("T", bound="OfferingOverviewUpdate")


@_attrs_define
class OfferingOverviewUpdate:
    """
    Attributes:
        name (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        offering_overview_update.additional_properties = d
        return offering_overview_update
