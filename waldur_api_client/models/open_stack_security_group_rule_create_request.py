...
T = TypeVar("T", bound="OpenStackSecurityGroupRuleCreateRequest")


@_attrs_define
class OpenStackSecurityGroupRuleCreateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_stack_security_group_rule_create_request = cls(
            ethertype=ethertype,
            direction=direction,
            protocol=protocol,
            from_port=from_port,
        ...
        open_stack_security_group_rule_create_request.additional_properties = d
        return open_stack_security_group_rule_create_request
