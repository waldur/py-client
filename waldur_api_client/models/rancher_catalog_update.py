...
T = TypeVar("T", bound="RancherCatalogUpdate")


@_attrs_define
class RancherCatalogUpdate:
    """
    Attributes:
        uuid (UUID):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rancher_catalog_update.additional_properties = d
        return rancher_catalog_update
