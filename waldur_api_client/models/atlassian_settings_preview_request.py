...
if TYPE_CHECKING:
    from ..models.atlassian_settings_preview_request_support_type_mapping import (
        AtlassianSettingsPreviewRequestSupportTypeMapping,
    )


T = TypeVar("T", bound="AtlassianSettingsPreviewRequest")
...
class AtlassianSettingsPreviewRequest:
    ...
    Attributes:
        ...
        support_type_mapping (Union[Unset, AtlassianSettingsPreviewRequestSupportTypeMapping]): Mapping from frontend
            types to backend request types
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        support_type_mapping: Union[Unset, AtlassianSettingsPreviewRequestSupportTypeMapping]
        if isinstance(_support_type_mapping, Unset):
            support_type_mapping = UNSET
        else:
            support_type_mapping = AtlassianSettingsPreviewRequestSupportTypeMapping.from_dict(_support_type_mapping)
        ...
        atlassian_settings_preview_request = cls(
            api_url=api_url,
            auth_method=auth_method,
            project_id=project_id,
            email=email,
        ...
        atlassian_settings_preview_request.additional_properties = d
        return atlassian_settings_preview_request
