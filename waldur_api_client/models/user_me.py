...
class UserMe:
    ...
    Attributes:
        ...
        permissions (Union[Unset, list['MePermission']]):
    ...
    permissions: Union[Unset, list["MePermission"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for permissions_item_data in _permissions or []:
            permissions_item = MePermission.from_dict(permissions_item_data)
        ...
        if isinstance(_profile_completeness, Unset):
            profile_completeness = UNSET
        else:
            profile_completeness = ProfileCompleteness.from_dict(_profile_completeness)
