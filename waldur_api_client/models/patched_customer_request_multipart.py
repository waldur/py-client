...
if TYPE_CHECKING:
    from ..models.patched_customer_request_multipart_user_affiliations import (
        PatchedCustomerRequestMultipartUserAffiliations,
    )
    from ..models.patched_customer_request_multipart_user_email_patterns import (
        PatchedCustomerRequestMultipartUserEmailPatterns,
    )
    from ..models.patched_customer_request_multipart_user_identity_sources import (
...
class PatchedCustomerRequestMultipart:
    ...
    Attributes:
        ...
        grace_period_days (Union[None, Unset, int]): Number of extra days after project end date before resources are
            terminated
        user_email_patterns (Union[Unset, PatchedCustomerRequestMultipartUserEmailPatterns]):
        user_affiliations (Union[Unset, PatchedCustomerRequestMultipartUserAffiliations]):
        user_identity_sources (Union[Unset, PatchedCustomerRequestMultipartUserIdentitySources]): List of allowed
    ...
    user_email_patterns: Union[Unset, "PatchedCustomerRequestMultipartUserEmailPatterns"] = UNSET
    user_affiliations: Union[Unset, "PatchedCustomerRequestMultipartUserAffiliations"] = UNSET
    user_identity_sources: Union[Unset, "PatchedCustomerRequestMultipartUserIdentitySources"] = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.blocked, Unset):
            files.append(("blocked", (None, str(self.blocked).encode(), "text/plain")))

        if not isinstance(self.archived, Unset):
            files.append(("archived", (None, str(self.archived).encode(), "text/plain")))

        if not isinstance(self.display_billing_info_in_projects, Unset):
            files.append(
                (
                    "display_billing_info_in_projects",
                    (None, str(self.display_billing_info_in_projects).encode(), "text/plain"),
                )
            )

        if not isinstance(self.default_tax_percent, Unset):
            files.append(("default_tax_percent", (None, str(self.default_tax_percent).encode(), "text/plain")))

        if not isinstance(self.accounting_start_date, Unset):
            files.append(
                ("accounting_start_date", (None, self.accounting_start_date.isoformat().encode(), "text/plain"))
            )

        if not isinstance(self.sponsor_number, Unset):
            if isinstance(self.sponsor_number, int):
                files.append(("sponsor_number", (None, str(self.sponsor_number).encode(), "text/plain")))
            else:
                files.append(("sponsor_number", (None, str(self.sponsor_number).encode(), "text/plain")))

        if not isinstance(self.max_service_accounts, Unset):
            if isinstance(self.max_service_accounts, int):
                files.append(("max_service_accounts", (None, str(self.max_service_accounts).encode(), "text/plain")))
            else:
                files.append(("max_service_accounts", (None, str(self.max_service_accounts).encode(), "text/plain")))

        if not isinstance(self.project_metadata_checklist, Unset):
            if isinstance(self.project_metadata_checklist, UUID):
                files.append(("project_metadata_checklist", (None, str(self.project_metadata_checklist), "text/plain")))
            else:
                files.append(
                    ("project_metadata_checklist", (None, str(self.project_metadata_checklist).encode(), "text/plain"))
                )
        ...
        if not isinstance(self.agreement_number, Unset):
            files.append(("agreement_number", (None, str(self.agreement_number).encode(), "text/plain")))
        ...
        if not isinstance(self.access_subnets, Unset):
            files.append(("access_subnets", (None, str(self.access_subnets).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user_email_patterns, Unset):
            ...
            user_email_patterns = PatchedCustomerRequestMultipartUserEmailPatterns.from_dict(_user_email_patterns)
        ...
        if isinstance(_user_affiliations, Unset):
            ...
            user_affiliations = PatchedCustomerRequestMultipartUserAffiliations.from_dict(_user_affiliations)

        _user_identity_sources = d.pop("user_identity_sources", UNSET)
        user_identity_sources: Union[Unset, PatchedCustomerRequestMultipartUserIdentitySources]
        if isinstance(_user_identity_sources, Unset):
            user_identity_sources = UNSET
        else:
            user_identity_sources = PatchedCustomerRequestMultipartUserIdentitySources.from_dict(_user_identity_sources)
