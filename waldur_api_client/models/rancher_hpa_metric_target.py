...
T = TypeVar("T", bound="RancherHPAMetricTarget")


@_attrs_define
class RancherHPAMetricTarget:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rancher_hpa_metric_target = cls(
            type_=type_,
            utilization=utilization,
            average_value=average_value,
        )

        rancher_hpa_metric_target.additional_properties = d
        return rancher_hpa_metric_target
