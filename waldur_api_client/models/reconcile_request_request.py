...
T = TypeVar("T", bound="ReconcileRequestRequest")


@_attrs_define
class ReconcileRequestRequest:
    """
    Attributes:
        year (int):
        month (int):
        settings_uuid (Union[Unset, UUID]):
        force (Union[Unset, bool]): Force reconciliation even if not validated Default: False.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reconcile_request_request.additional_properties = d
        return reconcile_request_request
