...
T = TypeVar("T", bound="ExportPlanComponentData")


@_attrs_define
class ExportPlanComponentData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_plan_component_data = cls(
            component_type=component_type,
            amount=amount,
            price=price,
            future_price=future_price,
        ...
        export_plan_component_data.additional_properties = d
        return export_plan_component_data
