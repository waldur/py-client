...
T = TypeVar("T", bound="SetAllowedDomainsRequest")


@_attrs_define
class SetAllowedDomainsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_allowed_domains_request = cls(
            allowed_domains=allowed_domains,
        )

        set_allowed_domains_request.additional_properties = d
        return set_allowed_domains_request
