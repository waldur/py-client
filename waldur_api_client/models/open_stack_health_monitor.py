...
if TYPE_CHECKING:
    from ..models.open_stack_health_monitor_marketplace_offering_plugin_options_type_0 import (
        OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0,
    )


T = TypeVar("T", bound="OpenStackHealthMonitor")


@_attrs_define
class OpenStackHealthMonitor:
    """
    Attributes:
        url (Union[Unset, str]):
        ...
        backend_id (Union[None, Unset, str]): Health monitor ID in Octavia
        access_url (Union[None, Unset, str]):
        pool (Union[Unset, str]): Pool this health monitor belongs to
        ...
        marketplace_offering_plugin_options (Union['OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    marketplace_offering_plugin_options: Union[
        "OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0", None, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pool_uuid: Union[Unset, str] = UNSET
        if not isinstance(self.pool_uuid, Unset):
            pool_uuid = str(self.pool_uuid)

        load_balancer_uuid: Union[Unset, str] = UNSET
        if not isinstance(self.load_balancer_uuid, Unset):
            load_balancer_uuid = str(self.load_balancer_uuid)
        ...
        if isinstance(self.marketplace_offering_plugin_options, Unset):
            ...
            self.marketplace_offering_plugin_options, OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0
        ):
        ...
        if pool_uuid is not UNSET:
            field_dict["pool_uuid"] = pool_uuid
        if load_balancer_uuid is not UNSET:
            field_dict["load_balancer_uuid"] = load_balancer_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _pool_uuid = d.pop("pool_uuid", UNSET)
        pool_uuid: Union[Unset, UUID]
        if isinstance(_pool_uuid, Unset):
            pool_uuid = UNSET
        else:
            pool_uuid = UUID(_pool_uuid)

        _load_balancer_uuid = d.pop("load_balancer_uuid", UNSET)
        load_balancer_uuid: Union[Unset, UUID]
        if isinstance(_load_balancer_uuid, Unset):
            load_balancer_uuid = UNSET
        else:
            load_balancer_uuid = UUID(_load_balancer_uuid)
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackHealthMonitorMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        open_stack_health_monitor.additional_properties = d
        return open_stack_health_monitor
