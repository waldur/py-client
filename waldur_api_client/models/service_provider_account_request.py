...
T = TypeVar("T", bound="ServiceProviderAccountRequest")


@_attrs_define
class ServiceProviderAccountRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_provider_account_request = cls(
            username=username,
        ...
        service_provider_account_request.additional_properties = d
        return service_provider_account_request
