...
class EventMetadataResponseEventGroupsAdditionalPropertyItem(str, Enum):
    ...
    PROJECT_END_DATE_CHANGE_REQUEST_APPROVED = "project_end_date_change_request_approved"
    PROJECT_END_DATE_CHANGE_REQUEST_CREATED = "project_end_date_change_request_created"
    PROJECT_END_DATE_CHANGE_REQUEST_REJECTED = "project_end_date_change_request_rejected"
