...
T = TypeVar("T", bound="PatchedInvoiceItemUpdateRequest")


@_attrs_define
class PatchedInvoiceItemUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_invoice_item_update_request.additional_properties = d
        return patched_invoice_item_update_request
