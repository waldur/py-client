...
T = TypeVar("T", bound="CallProposalFieldConfigRequest")


@_attrs_define
class CallProposalFieldConfigRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        call_proposal_field_config_request = cls(
        ...
        call_proposal_field_config_request.additional_properties = d
        return call_proposal_field_config_request
