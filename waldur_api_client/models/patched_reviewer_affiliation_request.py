...
T = TypeVar("T", bound="PatchedReviewerAffiliationRequest")


@_attrs_define
class PatchedReviewerAffiliationRequest:
    """
    Attributes:
        organization (Union[None, UUID, Unset]):
        organization_name (Union[Unset, str]): Organization name (used when not linked to Waldur org)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_reviewer_affiliation_request = cls(
        ...
        patched_reviewer_affiliation_request.additional_properties = d
        return patched_reviewer_affiliation_request
