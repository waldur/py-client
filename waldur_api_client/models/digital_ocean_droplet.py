...
class DigitalOceanDroplet:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union[Unset, DigitalOceanDropletMarketplaceOfferingPluginOptions]):
    ...
    marketplace_offering_plugin_options: Union[Unset, "DigitalOceanDropletMarketplaceOfferingPluginOptions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_marketplace_offering_plugin_options, Unset):
            ...
            marketplace_offering_plugin_options = DigitalOceanDropletMarketplaceOfferingPluginOptions.from_dict(
