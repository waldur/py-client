...
T = TypeVar("T", bound="PatchedChecklistCategoryRequest")


@_attrs_define
class PatchedChecklistCategoryRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_checklist_category_request = cls(
            icon=icon,
            name=name,
            description=description,
        )

        patched_checklist_category_request.additional_properties = d
        return patched_checklist_category_request
