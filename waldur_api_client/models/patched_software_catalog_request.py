...
if TYPE_CHECKING:
    from ..models.patched_software_catalog_request_metadata import PatchedSoftwareCatalogRequestMetadata
...
class PatchedSoftwareCatalogRequest:
    ...
    Attributes:
        ...
        metadata (Union[Unset, PatchedSoftwareCatalogRequestMetadata]): Catalog-specific metadata (architecture maps,
            API endpoints, etc.)
    ...
    metadata: Union[Unset, "PatchedSoftwareCatalogRequestMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata: Union[Unset, PatchedSoftwareCatalogRequestMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = PatchedSoftwareCatalogRequestMetadata.from_dict(_metadata)
