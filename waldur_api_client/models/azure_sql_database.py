...
class AzureSqlDatabase:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        server_uuid: Union[Unset, str] = UNSET
        if not isinstance(self.server_uuid, Unset):
            server_uuid = str(self.server_uuid)

        server_marketplace_uuid: Union[Unset, str] = UNSET
        if not isinstance(self.server_marketplace_uuid, Unset):
        ...
        if server_marketplace_uuid is not UNSET:
            field_dict["server_marketplace_uuid"] = server_marketplace_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _server_marketplace_uuid = d.pop("server_marketplace_uuid", UNSET)
        server_marketplace_uuid: Union[Unset, UUID]
        if isinstance(_server_marketplace_uuid, Unset):
            server_marketplace_uuid = UNSET
        else:
            server_marketplace_uuid = UUID(_server_marketplace_uuid)
