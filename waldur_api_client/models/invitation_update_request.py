...
T = TypeVar("T", bound="InvitationUpdateRequest")
...
class InvitationUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invitation_update_request = cls(
            email=email,
            role=role,
        )

        invitation_update_request.additional_properties = d
        return invitation_update_request
