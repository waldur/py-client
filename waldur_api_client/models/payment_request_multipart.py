...
T = TypeVar("T", bound="PaymentRequestMultipart")


@_attrs_define
class PaymentRequestMultipart:
    """
    Attributes:
        profile (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_request_multipart.additional_properties = d
        return payment_request_multipart
