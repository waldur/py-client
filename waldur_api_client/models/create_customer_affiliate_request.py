...
T = TypeVar("T", bound="CreateCustomerAffiliateRequest")


@_attrs_define
class CreateCustomerAffiliateRequest:
    """
    Attributes:
        customer (str):
        affiliate (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_customer_affiliate_request = cls(
            customer=customer,
            affiliate=affiliate,
        ...
        create_customer_affiliate_request.additional_properties = d
        return create_customer_affiliate_request
