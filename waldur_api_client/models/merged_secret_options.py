...
if TYPE_CHECKING:
    ...
    from ..models.script_env_var import ScriptEnvVar
...
class MergedSecretOptions:
    ...
    Attributes:
        ...
        environ (Union[Unset, list['ScriptEnvVar']]): Script environment variables
    ...
    environ: Union[Unset, list["ScriptEnvVar"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for environ_item_data in _environ or []:
            environ_item = ScriptEnvVar.from_dict(environ_item_data)
