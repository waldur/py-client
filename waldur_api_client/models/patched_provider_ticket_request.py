...
T = TypeVar("T", bound="PatchedProviderTicketRequest")


@_attrs_define
class PatchedProviderTicketRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_provider_ticket_request = cls(
            escalated_at=escalated_at,
            customer=customer,
            project=project,
        )

        patched_provider_ticket_request.additional_properties = d
        return patched_provider_ticket_request
