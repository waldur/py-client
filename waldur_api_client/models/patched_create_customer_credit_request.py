...
T = TypeVar("T", bound="PatchedCreateCustomerCreditRequest")


@_attrs_define
class PatchedCreateCustomerCreditRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_create_customer_credit_request = cls(
            value=value,
            customer=customer,
            offerings=offerings,
            end_date=end_date,
        ...
        patched_create_customer_credit_request.additional_properties = d
        return patched_create_customer_credit_request
