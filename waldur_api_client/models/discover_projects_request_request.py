...
T = TypeVar("T", bound="DiscoverProjectsRequestRequest")


@_attrs_define
class DiscoverProjectsRequestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discover_projects_request_request = cls(
            api_url=api_url,
            auth_method=auth_method,
            email=email,
            token=token,
        ...
        discover_projects_request_request.additional_properties = d
        return discover_projects_request_request
