...
if TYPE_CHECKING:
    from ..models.allocation_marketplace_offering_plugin_options_type_0 import (
...
class Allocation:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union['AllocationMarketplaceOfferingPluginOptionsType0', None, Unset]):
    ...
    marketplace_offering_plugin_options: Union["AllocationMarketplaceOfferingPluginOptionsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.marketplace_offering_plugin_options, AllocationMarketplaceOfferingPluginOptionsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["AllocationMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                marketplace_offering_plugin_options_type_0 = AllocationMarketplaceOfferingPluginOptionsType0.from_dict(
                    data
                )
                ...
                pass
            return cast(Union["AllocationMarketplaceOfferingPluginOptionsType0", None, Unset], data)
