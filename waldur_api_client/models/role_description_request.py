...
T = TypeVar("T", bound="RoleDescriptionRequest")


@_attrs_define
class RoleDescriptionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_description_request.additional_properties = d
        return role_description_request
