...
if TYPE_CHECKING:
    from ..models.open_stack_tenant_marketplace_offering_plugin_options_type_0 import (
        OpenStackTenantMarketplaceOfferingPluginOptionsType0,
    )
    from ..models.quota import Quota


T = TypeVar("T", bound="OpenStackTenant")
...
class OpenStackTenant:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.marketplace_offering_plugin_options, OpenStackTenantMarketplaceOfferingPluginOptionsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackTenantMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackTenantMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackTenantMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        open_stack_tenant.additional_properties = d
        return open_stack_tenant
