...
if TYPE_CHECKING:
    from ..models.open_stack_tenant_marketplace_offering_plugin_options import (
...
class OpenStackTenant:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union[Unset, OpenStackTenantMarketplaceOfferingPluginOptions]):
    ...
    marketplace_offering_plugin_options: Union[Unset, "OpenStackTenantMarketplaceOfferingPluginOptions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_marketplace_offering_plugin_options, Unset):
            ...
            marketplace_offering_plugin_options = OpenStackTenantMarketplaceOfferingPluginOptions.from_dict(
