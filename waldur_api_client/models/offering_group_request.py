...
T = TypeVar("T", bound="OfferingGroupRequest")


@_attrs_define
class OfferingGroupRequest:
    """
    Attributes:
        title (str):
        customer (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        offering_group_request.additional_properties = d
        return offering_group_request
