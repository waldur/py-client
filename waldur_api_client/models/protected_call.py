...
class ProtectedCall:
    ...
    Attributes:
        ...
        default_project_role_name (str):
        default_project_role_description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_project_role_name = d.pop("default_project_role_name")

        default_project_role_description = d.pop("default_project_role_description")
