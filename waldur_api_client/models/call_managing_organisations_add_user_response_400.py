...
T = TypeVar("T", bound="CallManagingOrganisationsAddUserResponse400")


@_attrs_define
class CallManagingOrganisationsAddUserResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        call_managing_organisations_add_user_response_400 = cls(
            non_field_errors=non_field_errors,
        )

        call_managing_organisations_add_user_response_400.additional_properties = d
        return call_managing_organisations_add_user_response_400
