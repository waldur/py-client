...
if TYPE_CHECKING:
    from ..models.patched_user_request_form_eduperson_assurance import PatchedUserRequestFormEdupersonAssurance
    from ..models.patched_user_request_form_managed_isds import PatchedUserRequestFormManagedIsds
    from ..models.patched_user_request_form_nationalities import PatchedUserRequestFormNationalities
...
class PatchedUserRequestForm:
    ...
    Attributes:
        ...
        nationalities (Union[Unset, PatchedUserRequestFormNationalities]): List of all citizenships (ISO 3166-1 alpha-2
            codes)
        ...
        eduperson_assurance (Union[Unset, PatchedUserRequestFormEdupersonAssurance]): REFEDS assurance profile URIs from
            identity provider
        ...
        managed_isds (Union[Unset, PatchedUserRequestFormManagedIsds]): List of ISD source identifiers this user can
    ...
    nationalities: Union[Unset, "PatchedUserRequestFormNationalities"] = UNSET
    ...
    eduperson_assurance: Union[Unset, "PatchedUserRequestFormEdupersonAssurance"] = UNSET
    is_identity_manager: Union[Unset, bool] = UNSET
    can_use_personal_access_tokens: Union[Unset, bool] = UNSET
    managed_isds: Union[Unset, "PatchedUserRequestFormManagedIsds"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nationalities: Union[Unset, PatchedUserRequestFormNationalities]
        if isinstance(_nationalities, Unset):
            nationalities = UNSET
        else:
            nationalities = PatchedUserRequestFormNationalities.from_dict(_nationalities)
        ...
        eduperson_assurance: Union[Unset, PatchedUserRequestFormEdupersonAssurance]
        if isinstance(_eduperson_assurance, Unset):
            eduperson_assurance = UNSET
        else:
            eduperson_assurance = PatchedUserRequestFormEdupersonAssurance.from_dict(_eduperson_assurance)
        ...
        managed_isds: Union[Unset, PatchedUserRequestFormManagedIsds]
        if isinstance(_managed_isds, Unset):
            managed_isds = UNSET
        else:
            managed_isds = PatchedUserRequestFormManagedIsds.from_dict(_managed_isds)
