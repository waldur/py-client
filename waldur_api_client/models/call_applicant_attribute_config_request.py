...
T = TypeVar("T", bound="CallApplicantAttributeConfigRequest")


@_attrs_define
class CallApplicantAttributeConfigRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        call_applicant_attribute_config_request = cls(
            call=call,
        ...
        call_applicant_attribute_config_request.additional_properties = d
        return call_applicant_attribute_config_request
