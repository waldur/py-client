...
T = TypeVar("T", bound="CustomerComponentUsagePolicy")


@_attrs_define
class CustomerComponentUsagePolicy:
    """
    Attributes:
        uuid (UUID):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for component_limits_set_item_data in _component_limits_set:
            component_limits_set_item = NestedCustomerUsagePolicyComponent.from_dict(component_limits_set_item_data)
        ...
        customer_component_usage_policy.additional_properties = d
        return customer_component_usage_policy
