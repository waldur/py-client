...
if TYPE_CHECKING:
    from ..models.open_stack_pool_marketplace_offering_plugin_options_type_0 import (
        OpenStackPoolMarketplaceOfferingPluginOptionsType0,
    )


T = TypeVar("T", bound="OpenStackPool")
...
class OpenStackPool:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union['OpenStackPoolMarketplaceOfferingPluginOptionsType0', None, Unset]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.marketplace_offering_plugin_options, OpenStackPoolMarketplaceOfferingPluginOptionsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lb_algorithm = d.pop("lb_algorithm", UNSET)
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["OpenStackPoolMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    OpenStackPoolMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["OpenStackPoolMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        open_stack_pool.additional_properties = d
        return open_stack_pool
