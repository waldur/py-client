...
if TYPE_CHECKING:
    from ..models.patched_service_provider_request_form_allowed_domains import (
...
class PatchedServiceProviderRequestForm:
    ...
    Attributes:
        ...
        allowed_domains (Union[Unset, PatchedServiceProviderRequestFormAllowedDomains]): List of allowed domains for
    ...
    allowed_domains: Union[Unset, "PatchedServiceProviderRequestFormAllowedDomains"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allowed_domains: Union[Unset, PatchedServiceProviderRequestFormAllowedDomains]
        if isinstance(_allowed_domains, Unset):
            allowed_domains = UNSET
        else:
            allowed_domains = PatchedServiceProviderRequestFormAllowedDomains.from_dict(_allowed_domains)
