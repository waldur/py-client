...
T = TypeVar("T", bound="ConstanceSettingsRequestLOGINLOGOMULTILINGUAL")


@_attrs_define
class ConstanceSettingsRequestLOGINLOGOMULTILINGUAL:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        constance_settings_request_loginlogomultilingual = cls()
        ...
        constance_settings_request_loginlogomultilingual.additional_properties = additional_properties
        return constance_settings_request_loginlogomultilingual
