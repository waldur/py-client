...
if TYPE_CHECKING:
    from ..models.patched_requested_resource_request_attributes import PatchedRequestedResourceRequestAttributes
    from ..models.patched_requested_resource_request_limits import PatchedRequestedResourceRequestLimits
...
class PatchedRequestedResourceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PatchedRequestedResourceRequestAttributes.from_dict(_attributes)
