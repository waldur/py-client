...
T = TypeVar("T", bound="AtlassianCredentialsRequest")


@_attrs_define
class AtlassianCredentialsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        atlassian_credentials_request = cls(
            api_url=api_url,
            auth_method=auth_method,
            email=email,
            token=token,
        ...
        atlassian_credentials_request.additional_properties = d
        return atlassian_credentials_request
