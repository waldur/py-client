...
T = TypeVar("T", bound="PatchedOfferingGroupRequestForm")


@_attrs_define
class PatchedOfferingGroupRequestForm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_offering_group_request_form = cls(
            title=title,
            description=description,
            icon=icon,
        )

        patched_offering_group_request_form.additional_properties = d
        return patched_offering_group_request_form
