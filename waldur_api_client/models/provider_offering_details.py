...
T = TypeVar("T", bound="ProviderOfferingDetails")


@_attrs_define
class ProviderOfferingDetails:
    """
    Attributes:
        url (str):
        uuid (UUID):
        ...
        category_uuid (UUID):
        category_title (str):
        attributes (ProviderOfferingDetailsAttributes):
        ...
        service_attributes (ProviderOfferingDetailsServiceAttributes):
        state (OfferingState):
        state_code (StateCodeEnum):
        order_count (int):
        plans (list['BaseProviderPlan']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attributes = ProviderOfferingDetailsAttributes.from_dict(d.pop("attributes"))
        ...
        service_attributes = ProviderOfferingDetailsServiceAttributes.from_dict(d.pop("service_attributes"))
        ...
        integration_status = []
        _integration_status = d.pop("integration_status")
        for integration_status_item_data in _integration_status:
        ...
        provider_offering_details.additional_properties = d
        return provider_offering_details
