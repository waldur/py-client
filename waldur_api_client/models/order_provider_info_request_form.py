...
T = TypeVar("T", bound="OrderProviderInfoRequestForm")


@_attrs_define
class OrderProviderInfoRequestForm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order_provider_info_request_form = cls(
            provider_message=provider_message,
            provider_message_url=provider_message_url,
            provider_message_attachment=provider_message_attachment,
        )

        order_provider_info_request_form.additional_properties = d
        return order_provider_info_request_form
