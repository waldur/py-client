...
T = TypeVar("T", bound="ArrowCustomerMappingCreateRequest")


@_attrs_define
class ArrowCustomerMappingCreateRequest:
    """
    Attributes:
        settings (UUID):
        arrow_reference (str): Arrow customer ID (e.g., 'XSP661245')
        waldur_customer (UUID):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        waldur_customer = str(self.waldur_customer)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        waldur_customer = UUID(d.pop("waldur_customer"))

        arrow_company_name = d.pop("arrow_company_name", UNSET)

        is_active = d.pop("is_active", UNSET)

        arrow_customer_mapping_create_request = cls(
            settings=settings,
            arrow_reference=arrow_reference,
            waldur_customer=waldur_customer,
        ...
        arrow_customer_mapping_create_request.additional_properties = d
        return arrow_customer_mapping_create_request
