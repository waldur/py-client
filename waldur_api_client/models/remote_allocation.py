...
if TYPE_CHECKING:
    from ..models.remote_allocation_marketplace_offering_plugin_options_type_0 import (
        RemoteAllocationMarketplaceOfferingPluginOptionsType0,
    )


T = TypeVar("T", bound="RemoteAllocation")
...
class RemoteAllocation:
    ...
    Attributes:
        ...
        marketplace_offering_plugin_options (Union['RemoteAllocationMarketplaceOfferingPluginOptionsType0', None,
            Unset]):
    ...
    marketplace_offering_plugin_options: Union["RemoteAllocationMarketplaceOfferingPluginOptionsType0", None, Unset] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marketplace_offering_plugin_options, Unset):
            ...
            self.marketplace_offering_plugin_options, RemoteAllocationMarketplaceOfferingPluginOptionsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marketplace_offering_plugin_options(
            data: object,
        ) -> Union["RemoteAllocationMarketplaceOfferingPluginOptionsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                marketplace_offering_plugin_options_type_0 = (
                    RemoteAllocationMarketplaceOfferingPluginOptionsType0.from_dict(data)
                )

                return marketplace_offering_plugin_options_type_0
            except:  # noqa: E722
                pass
            return cast(Union["RemoteAllocationMarketplaceOfferingPluginOptionsType0", None, Unset], data)
        ...
        remote_allocation.additional_properties = d
        return remote_allocation
