...
T = TypeVar("T", bound="ExportTermsOfServiceDataRequest")


@_attrs_define
class ExportTermsOfServiceDataRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_terms_of_service_data_request = cls(
            terms_of_service=terms_of_service,
            terms_of_service_link=terms_of_service_link,
            version=version,
            is_active=is_active,
        ...
        export_terms_of_service_data_request.additional_properties = d
        return export_terms_of_service_data_request
