...
T = TypeVar("T", bound="CountProjectsOfServiceProviders")


@_attrs_define
class CountProjectsOfServiceProviders:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        count_projects_of_service_providers = cls(
            service_provider_uuid=service_provider_uuid,
            customer_uuid=customer_uuid,
            customer_name=customer_name,
            customer_organization_group_uuid=customer_organization_group_uuid,
        ...
        count_projects_of_service_providers.additional_properties = d
        return count_projects_of_service_providers
