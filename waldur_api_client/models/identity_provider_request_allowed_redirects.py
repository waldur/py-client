...
T = TypeVar("T", bound="IdentityProviderRequestAllowedRedirects")


@_attrs_define
class IdentityProviderRequestAllowedRedirects:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        identity_provider_request_allowed_redirects = cls()

        identity_provider_request_allowed_redirects.additional_properties = d
        return identity_provider_request_allowed_redirects
