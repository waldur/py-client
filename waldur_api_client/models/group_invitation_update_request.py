...
if TYPE_CHECKING:
    from ..models.group_invitation_update_request_user_affiliations import GroupInvitationUpdateRequestUserAffiliations
    from ..models.group_invitation_update_request_user_email_patterns import (
        GroupInvitationUpdateRequestUserEmailPatterns,
    )
    from ..models.group_invitation_update_request_user_identity_sources import (
...
class GroupInvitationUpdateRequest:
    ...
    Attributes:
        ...
        user_affiliations (Union[Unset, GroupInvitationUpdateRequestUserAffiliations]):
        user_email_patterns (Union[Unset, GroupInvitationUpdateRequestUserEmailPatterns]):
        user_identity_sources (Union[Unset, GroupInvitationUpdateRequestUserIdentitySources]): List of allowed identity
    ...
    user_affiliations: Union[Unset, "GroupInvitationUpdateRequestUserAffiliations"] = UNSET
    user_email_patterns: Union[Unset, "GroupInvitationUpdateRequestUserEmailPatterns"] = UNSET
    user_identity_sources: Union[Unset, "GroupInvitationUpdateRequestUserIdentitySources"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.group_invitation_update_request_user_affiliations import (
        ...
        if isinstance(_user_affiliations, Unset):
            ...
            user_affiliations = GroupInvitationUpdateRequestUserAffiliations.from_dict(_user_affiliations)
        ...
        if isinstance(_user_email_patterns, Unset):
            ...
            user_email_patterns = GroupInvitationUpdateRequestUserEmailPatterns.from_dict(_user_email_patterns)

        _user_identity_sources = d.pop("user_identity_sources", UNSET)
        user_identity_sources: Union[Unset, GroupInvitationUpdateRequestUserIdentitySources]
        if isinstance(_user_identity_sources, Unset):
            user_identity_sources = UNSET
        else:
            user_identity_sources = GroupInvitationUpdateRequestUserIdentitySources.from_dict(_user_identity_sources)
