...
T = TypeVar("T", bound="OpenStackCredentialsRequest")


@_attrs_define
class OpenStackCredentialsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_stack_credentials_request = cls(
            auth_url=auth_url,
            username=username,
            password=password,
        ...
        open_stack_credentials_request.additional_properties = d
        return open_stack_credentials_request
