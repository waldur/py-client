...
@_attrs_define
class PatchedReviewerProfileCreateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_reviewer_profile_create_request = cls(
            orcid_id=orcid_id,
            biography=biography,
        ...
        patched_reviewer_profile_create_request.additional_properties = d
        return patched_reviewer_profile_create_request
