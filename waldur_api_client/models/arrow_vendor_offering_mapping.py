...
T = TypeVar("T", bound="ArrowVendorOfferingMapping")


@_attrs_define
class ArrowVendorOfferingMapping:
    """
    Attributes:
        uuid (UUID):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arrow_vendor_offering_mapping = cls(
            uuid=uuid,
            url=url,
            settings=settings,
            settings_uuid=settings_uuid,
        ...
        arrow_vendor_offering_mapping.additional_properties = d
        return arrow_vendor_offering_mapping
