...
T = TypeVar("T", bound="PatchedOfferingQoSUpdateRequest")


@_attrs_define
class PatchedOfferingQoSUpdateRequest:
    """
    Attributes:
        qos_uuid (Union[Unset, UUID]):
        name (Union[Unset, str]): Name of the SLURM QOS.
    ...
    qos_uuid: Union[Unset, UUID] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        qos_uuid: Union[Unset, str] = UNSET
        if not isinstance(self.qos_uuid, Unset):
        ...
        field_dict.update({})
        if qos_uuid is not UNSET:
            field_dict["qos_uuid"] = qos_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        _qos_uuid = d.pop("qos_uuid", UNSET)
        qos_uuid: Union[Unset, UUID]
        if isinstance(_qos_uuid, Unset):
            qos_uuid = UNSET
        else:
            qos_uuid = UUID(_qos_uuid)
        ...
        patched_offering_qo_s_update_request = cls(
            qos_uuid=qos_uuid,
            name=name,
        ...
        patched_offering_qo_s_update_request.additional_properties = d
        return patched_offering_qo_s_update_request
