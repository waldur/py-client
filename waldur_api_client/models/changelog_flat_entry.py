...
if TYPE_CHECKING:
    ...
    from ..models.changelog_flat_entry_plugin_analysis import ChangelogFlatEntryPluginAnalysis
    from ..models.changelog_flat_entry_settings_analysis import ChangelogFlatEntrySettingsAnalysis
...
T = TypeVar("T", bound="ChangelogFlatEntry")


@_attrs_define
class ChangelogFlatEntry:
    """
    Attributes:
        id (str):
        type_ (str):
        ...
        settings_analysis (Union[Unset, ChangelogFlatEntrySettingsAnalysis]):
        plugin_analysis (Union[Unset, ChangelogFlatEntryPluginAnalysis]):
    """
    ...
    settings_analysis: Union[Unset, "ChangelogFlatEntrySettingsAnalysis"] = UNSET
    plugin_analysis: Union[Unset, "ChangelogFlatEntryPluginAnalysis"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        release_type = d.pop("release_type")
        ...
        if isinstance(_settings_analysis, Unset):
            ...
            settings_analysis = ChangelogFlatEntrySettingsAnalysis.from_dict(_settings_analysis)
        ...
        if isinstance(_plugin_analysis, Unset):
            ...
            plugin_analysis = ChangelogFlatEntryPluginAnalysis.from_dict(_plugin_analysis)

        changelog_flat_entry = cls(
            id=id,
            type_=type_,
            category=category,
            title=title,
        ...
        changelog_flat_entry.additional_properties = d
        return changelog_flat_entry
