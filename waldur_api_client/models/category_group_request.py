...
T = TypeVar("T", bound="CategoryGroupRequest")


@_attrs_define
class CategoryGroupRequest:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category_group_request = cls(
            title=title,
            description=description,
            icon=icon,
        )

        category_group_request.additional_properties = d
        return category_group_request
