...
T = TypeVar("T", bound="OfferingIntegrationUpdate")


@_attrs_define
class OfferingIntegrationUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        offering_integration_update = cls(
        ...
        offering_integration_update.additional_properties = d
        return offering_integration_update
