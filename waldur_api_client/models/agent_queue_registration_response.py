...
T = TypeVar("T", bound="AgentQueueRegistrationResponse")


@_attrs_define
class AgentQueueRegistrationResponse:
    """
    Attributes:
        ...
        observable_object_types (list[str]): List of observable object types routed to this queue
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_queue_registration_response = cls(
            rmq_username=rmq_username,
            queue_name=queue_name,
            vhost=vhost,
            observable_object_types=observable_object_types,
        ...
        agent_queue_registration_response.additional_properties = d
        return agent_queue_registration_response
