...
T = TypeVar("T", bound="ArrowBillingSyncItemDetail")


@_attrs_define
class ArrowBillingSyncItemDetail:
    """
    Attributes:
        uuid (UUID):
        url (str):
        billing_sync (str):
        billing_sync_uuid (UUID):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        billing_sync_uuid = str(self.billing_sync_uuid)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billing_sync = d.pop("billing_sync")

        billing_sync_uuid = UUID(d.pop("billing_sync_uuid"))
        ...
        has_compensation = d.pop("has_compensation")
        ...
        arrow_billing_sync_item_detail = cls(
            uuid=uuid,
            url=url,
            billing_sync=billing_sync,
            billing_sync_uuid=billing_sync_uuid,
        ...
        arrow_billing_sync_item_detail.additional_properties = d
        return arrow_billing_sync_item_detail
