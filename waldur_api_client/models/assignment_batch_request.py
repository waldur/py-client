...
T = TypeVar("T", bound="AssignmentBatchRequest")


@_attrs_define
class AssignmentBatchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignment_batch_request = cls(
            manager_notes=manager_notes,
        )

        assignment_batch_request.additional_properties = d
        return assignment_batch_request
