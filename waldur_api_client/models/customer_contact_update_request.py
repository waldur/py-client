...
T = TypeVar("T", bound="CustomerContactUpdateRequest")
...
class CustomerContactUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customer_contact_update_request = cls(
        ...
        customer_contact_update_request.additional_properties = d
        return customer_contact_update_request
