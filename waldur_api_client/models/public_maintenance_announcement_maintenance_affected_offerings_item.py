...
T = TypeVar("T", bound="PublicMaintenanceAnnouncementMaintenanceAffectedOfferingsItem")


@_attrs_define
class PublicMaintenanceAnnouncementMaintenanceAffectedOfferingsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_maintenance_announcement_maintenance_affected_offerings_item = cls(
            uuid=uuid,
            name=name,
        ...
        public_maintenance_announcement_maintenance_affected_offerings_item.additional_properties = d
        return public_maintenance_announcement_maintenance_affected_offerings_item
