...
class OpenStackSecurityGroupRuleUpdateRequest:
    ...
    Attributes:
        ...
        direction (Union[Unset, SecurityGroupRuleDirectionEnum]):  Default: SecurityGroupRuleDirectionEnum.INGRESS.
    ...
    direction: Union[Unset, SecurityGroupRuleDirectionEnum] = SecurityGroupRuleDirectionEnum.INGRESS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_stack_security_group_rule_update_request = cls(
            ethertype=ethertype,
            direction=direction,
            protocol=protocol,
            from_port=from_port,
        ...
        open_stack_security_group_rule_update_request.additional_properties = d
        return open_stack_security_group_rule_update_request
