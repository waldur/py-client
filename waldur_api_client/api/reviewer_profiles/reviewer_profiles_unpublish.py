...
from ...models.reviewer_profiles_unpublish_response_200 import ReviewerProfilesUnpublishResponse200
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ReviewerProfilesUnpublishResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[ReviewerProfilesUnpublishResponse200]:
    return Response(
