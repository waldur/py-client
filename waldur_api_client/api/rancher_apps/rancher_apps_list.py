...
def _get_kwargs(
    *,
    ...
    json_template_uuid: Union[Unset, str] = UNSET
    if not isinstance(template_uuid, Unset):
...
) -> Optional[list["RancherApplication"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_rancher_application_list_item_data in _response_200:
            componentsschemas_paginated_rancher_application_list_item = RancherApplication.from_dict(
                componentsschemas_paginated_rancher_application_list_item_data
            )

            response_200.append(componentsschemas_paginated_rancher_application_list_item)
