...
from ...models.rancher_apps_head_state_item import RancherAppsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherAppsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherAppsHeadStateItem]]):
