...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/customers/{uuid}/providers/",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """List service providers serving this customer

     Returns service providers with at least one active resource provisioned for this customer.
