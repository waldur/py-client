...
from ...models.open_stack_network import OpenStackNetwork
from ...models.openstack_networks_list_field_item import OpenstackNetworksListFieldItem
from ...models.openstack_networks_list_state_item import OpenstackNetworksListStateItem
...
) -> Optional[list["OpenStackNetwork"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_network_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_network_list_item = OpenStackNetwork.from_dict(
                componentsschemas_paginated_open_stack_network_list_item_data
            )

            response_200.append(componentsschemas_paginated_open_stack_network_list_item)
