...
from ...models.project_credits_head_o_item import ProjectCreditsHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[ProjectCreditsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[ProjectCreditsHeadOItem]]):
