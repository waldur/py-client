...
from ...models.slurm_allocations_count_state_item import SlurmAllocationsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[SlurmAllocationsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[SlurmAllocationsCountStateItem]]):
