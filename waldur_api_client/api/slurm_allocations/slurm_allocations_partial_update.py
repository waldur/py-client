...
from ...models.patched_slurm_allocation_request import PatchedSlurmAllocationRequest
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> SlurmAllocation:
