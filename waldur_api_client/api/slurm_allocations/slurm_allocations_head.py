...
from ...models.slurm_allocations_head_state_item import SlurmAllocationsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[SlurmAllocationsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[SlurmAllocationsHeadStateItem]]):
