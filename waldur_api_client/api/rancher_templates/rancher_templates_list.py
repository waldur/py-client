...
from ...models.rancher_template import RancherTemplate
from ...models.rancher_templates_list_o_item import RancherTemplatesListOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[RancherTemplatesListOItem]] = UNSET,
...
) -> Optional[list["RancherTemplate"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_rancher_template_list_item_data in _response_200:
            componentsschemas_paginated_rancher_template_list_item = RancherTemplate.from_dict(
                componentsschemas_paginated_rancher_template_list_item_data
            )

            response_200.append(componentsschemas_paginated_rancher_template_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[RancherTemplatesListOItem]]):
