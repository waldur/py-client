...
from ...models.digitalocean_droplets_list_field_item import DigitaloceanDropletsListFieldItem
from ...models.digitalocean_droplets_list_state_item import DigitaloceanDropletsListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[DigitaloceanDropletsListFieldItem]] = UNSET,
...
) -> Optional[list["DigitalOceanDroplet"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_digital_ocean_droplet_list_item_data in _response_200:
            componentsschemas_paginated_digital_ocean_droplet_list_item = DigitalOceanDroplet.from_dict(
                componentsschemas_paginated_digital_ocean_droplet_list_item_data
            )

            response_200.append(componentsschemas_paginated_digital_ocean_droplet_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[DigitaloceanDropletsListFieldItem]]):
        ...
        state (Union[Unset, list[DigitaloceanDropletsListStateItem]]):
