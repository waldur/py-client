...
from ...models.digitalocean_droplets_count_state_item import DigitaloceanDropletsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[DigitaloceanDropletsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[DigitaloceanDropletsCountStateItem]]):
