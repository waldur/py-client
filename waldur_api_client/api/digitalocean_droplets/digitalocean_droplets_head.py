...
from ...models.digitalocean_droplets_head_state_item import DigitaloceanDropletsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[DigitaloceanDropletsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[DigitaloceanDropletsHeadStateItem]]):
