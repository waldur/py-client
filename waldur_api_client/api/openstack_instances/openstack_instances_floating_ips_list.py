...
from ...models.openstack_instances_floating_ips_list_state_item import OpenstackInstancesFloatingIpsListStateItem
...
def _get_kwargs(
    ...
    *,
    ...
    state: Union[Unset, list[OpenstackInstancesFloatingIpsListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/openstack-instances/{uuid_path}/floating_ips/",
        "params": params,
    }
...
) -> Optional[list["OpenStackNestedFloatingIP"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_nested_floating_ip_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_nested_floating_ip_list_item = OpenStackNestedFloatingIP.from_dict(
                componentsschemas_paginated_open_stack_nested_floating_ip_list_item_data
            )

            response_200.append(componentsschemas_paginated_open_stack_nested_floating_ip_list_item)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackInstancesFloatingIpsListStateItem]]):
