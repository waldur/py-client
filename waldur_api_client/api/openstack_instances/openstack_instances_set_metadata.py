...
from ...models.instance_set_metadata_request import InstanceSetMetadataRequest
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: InstanceSetMetadataRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/openstack-instances/{uuid}/set_metadata/",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Set instance metadata
     ...
     Replace the instance metadata with the given string key/value pairs. Keys absent from the payload
