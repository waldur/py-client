...
from ...models.open_stack_backup_request import OpenStackBackupRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/openstack-instances/{uuid}/backup/",
    }

    if isinstance(body, OpenStackBackupRequest):
