...
from ...models.arrow_vendor_offering_mapping import ArrowVendorOfferingMapping
...
def _get_kwargs(
    *,
    ...
    params["arrow_vendor_name"] = arrow_vendor_name
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["ArrowVendorOfferingMapping"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ArrowVendorOfferingMapping.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["ArrowVendorOfferingMapping"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """
    Args:
        arrow_vendor_name (Union[Unset, str]):
...
def sync_all(
    *,
    ...
    Returns:
        list['ArrowVendorOfferingMapping']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ArrowVendorOfferingMapping] = []
