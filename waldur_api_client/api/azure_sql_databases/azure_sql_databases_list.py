...
from ...models.azure_sql_databases_list_field_item import AzureSqlDatabasesListFieldItem
from ...models.azure_sql_databases_list_state_item import AzureSqlDatabasesListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[AzureSqlDatabasesListFieldItem]] = UNSET,
    ...
    json_server_uuid: Union[Unset, str] = UNSET
    if not isinstance(server_uuid, Unset):
        json_server_uuid = str(server_uuid)
    params["server_uuid"] = json_server_uuid
...
) -> Optional[list["AzureSqlDatabase"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_azure_sql_database_list_item_data in _response_200:
            componentsschemas_paginated_azure_sql_database_list_item = AzureSqlDatabase.from_dict(
                componentsschemas_paginated_azure_sql_database_list_item_data
            )

            response_200.append(componentsschemas_paginated_azure_sql_database_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[AzureSqlDatabasesListFieldItem]]):
        ...
        state (Union[Unset, list[AzureSqlDatabasesListStateItem]]):
