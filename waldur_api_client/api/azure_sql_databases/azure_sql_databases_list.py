...
from ...models.azure_sql_database_field_enum import AzureSqlDatabaseFieldEnum
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[AzureSqlDatabaseFieldEnum]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[AzureSqlDatabaseFieldEnum]]):
