...
from ...models.azure_sql_databases_head_state_item import AzureSqlDatabasesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzureSqlDatabasesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzureSqlDatabasesHeadStateItem]]):
