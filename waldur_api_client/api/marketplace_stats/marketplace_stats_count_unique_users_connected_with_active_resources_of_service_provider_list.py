...
def sync_all(
    *,
    ...
    Returns:
        list['CountUniqueUsersConnectedWithActiveResourcesOfServiceProvider']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[CountUniqueUsersConnectedWithActiveResourcesOfServiceProvider] = []
