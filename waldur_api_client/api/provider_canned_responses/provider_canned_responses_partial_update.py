...
from ...models.patched_provider_canned_response_request import PatchedProviderCannedResponseRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/provider-canned-responses/{uuid}/",
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> ProviderCannedResponse:
    ...
    if response.status_code == 200:
        response_200 = ProviderCannedResponse.from_dict(response.json())
