...
from ...models.rmq_stats_response import RmqStatsResponse
...
) -> Union[RmqStatsError, RmqStatsResponse]:
    if response.status_code == 404:
        raise errors.UnexpectedStatus(response.status_code, response.content, response.url)
    if response.status_code == 200:
        response_200 = RmqStatsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RmqStatsError, RmqStatsResponse]]:
    return Response(
