...
def _get_kwargs(
    uuid: UUID,
    *,
    accessor_type: Union[Unset, str] = UNSET,
    ...
    params["accessor_type"] = accessor_type
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/users/{uuid}/data_access_history/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = UserDataAccessLog.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["UserDataAccessLog"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get user data access history
     ...
     Shows historical log of who has accessed the user's profile data. Regular users see anonymized
    accessor categories. Staff/support see full details including accessor identity, IP, and context.

    Args:
        uuid (UUID):
        accessor_type (Union[Unset, str]):
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['UserDataAccessLog']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[UserDataAccessLog] = []
