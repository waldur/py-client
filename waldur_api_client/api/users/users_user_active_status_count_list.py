...
from ...models.user_active_status_count import UserActiveStatusCount
from ...models.users_user_active_status_count_list_o_item import UsersUserActiveStatusCountListOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[UsersUserActiveStatusCountListOItem]] = UNSET,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = UserActiveStatusCount.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["UserActiveStatusCount"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[UsersUserActiveStatusCountListOItem]]):
...
def sync_all(
    *,
    ...
    Returns:
        list['UserActiveStatusCount']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[UserActiveStatusCount] = []
