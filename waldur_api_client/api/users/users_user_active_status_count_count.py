...
from ...models.users_user_active_status_count_count_o_item import UsersUserActiveStatusCountCountOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[UsersUserActiveStatusCountCountOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[UsersUserActiveStatusCountCountOItem]]):
