...
from ...models.user_language_count import UserLanguageCount
from ...models.users_user_language_count_list_o_item import UsersUserLanguageCountListOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[UsersUserLanguageCountListOItem]] = UNSET,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = UserLanguageCount.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["UserLanguageCount"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[UsersUserLanguageCountListOItem]]):
...
def sync_all(
    *,
    ...
    Returns:
        list['UserLanguageCount']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[UserLanguageCount] = []
