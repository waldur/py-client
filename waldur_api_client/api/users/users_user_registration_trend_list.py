...
from ...models.user_registration_trend import UserRegistrationTrend
from ...models.users_user_registration_trend_list_o_item import UsersUserRegistrationTrendListOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[UsersUserRegistrationTrendListOItem]] = UNSET,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = UserRegistrationTrend.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["UserRegistrationTrend"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[UsersUserRegistrationTrendListOItem]]):
...
def sync_all(
    *,
    ...
    Returns:
        list['UserRegistrationTrend']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[UserRegistrationTrend] = []
