...
from ...models.openstack_subnets_head_state_item import OpenstackSubnetsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackSubnetsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSubnetsHeadStateItem]]):
