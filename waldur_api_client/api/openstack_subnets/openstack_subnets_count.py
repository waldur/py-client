...
from ...models.openstack_subnets_count_state_item import OpenstackSubnetsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackSubnetsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSubnetsCountStateItem]]):
