...
from ...models.patched_open_stack_sub_net_request import PatchedOpenStackSubNetRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedOpenStackSubNetRequest):
