...
from ...models.affiliate_fee_accrual import AffiliateFeeAccrual
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/customer-affiliates/{uuid}/accruals/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AffiliateFeeAccrual.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["AffiliateFeeAccrual"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List fees accrued from this affiliate link. Exposes the fee amount and invoice period only — never
    the referred customer's invoice contents.
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['AffiliateFeeAccrual']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[AffiliateFeeAccrual] = []
