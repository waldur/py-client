...
from ...models.openportal_allocations_count_state_item import OpenportalAllocationsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenportalAllocationsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenportalAllocationsCountStateItem]]):
