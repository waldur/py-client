...
from ...models.open_stack_volume_availability_zone import OpenStackVolumeAvailabilityZone
...
) -> Optional[list["OpenStackVolumeAvailabilityZone"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_volume_availability_zone_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_volume_availability_zone_list_item = (
                OpenStackVolumeAvailabilityZone.from_dict(
                    componentsschemas_paginated_open_stack_volume_availability_zone_list_item_data
                )
            )

            response_200.append(componentsschemas_paginated_open_stack_volume_availability_zone_list_item)
