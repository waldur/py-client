...
from ...models.open_stack_listener import OpenStackListener
from ...models.open_stack_listener_field_enum import OpenStackListenerFieldEnum
...
def _get_kwargs(
    *,
    field: Union[Unset, list[OpenStackListenerFieldEnum]] = UNSET,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = OpenStackListener.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["OpenStackListener"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        field (Union[Unset, list[OpenStackListenerFieldEnum]]):
        load_balancer (Union[Unset, str]):
...
def sync_all(
    *,
    ...
    Returns:
        list['OpenStackListener']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[OpenStackListener] = []
