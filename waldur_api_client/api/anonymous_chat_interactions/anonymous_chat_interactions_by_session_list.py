...
def _get_kwargs(
    ...
    *,
    ...
    session_id_query: Union[Unset, str] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/anonymous-chat-interactions/by-session/{session_id_path}/",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Full transcript for one anonymous session
     ...
     Returns the ordered list of interactions belonging to the given ``session_id``. Use this to read a
    ...
    Args:
        ...
        session_id_query (Union[Unset, str]):
