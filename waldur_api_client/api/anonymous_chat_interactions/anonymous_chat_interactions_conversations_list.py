...
from ...models.anonymous_chat_conversation import AnonymousChatConversation
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AnonymousChatConversation.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    """Conversations grouped by session
     ...
     One row per anonymous conversation (``session_id``) with aggregate counters, mirroring the
    authenticated threads table. Honours the same filters as the list endpoint. Read a conversation's
...
def sync_all(
    *,
    ...
    Returns:
        list['AnonymousChatConversation']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[AnonymousChatConversation] = []
