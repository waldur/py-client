...
from ...models.azure_public_ips_count_state_item import AzurePublicIpsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzurePublicIpsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzurePublicIpsCountStateItem]]):
