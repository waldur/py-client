...
from ...models.azure_public_ips_list_field_item import AzurePublicIpsListFieldItem
from ...models.azure_public_ips_list_state_item import AzurePublicIpsListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[AzurePublicIpsListFieldItem]] = UNSET,
...
) -> Optional[list["AzurePublicIP"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_azure_public_ip_list_item_data in _response_200:
            componentsschemas_paginated_azure_public_ip_list_item = AzurePublicIP.from_dict(
                componentsschemas_paginated_azure_public_ip_list_item_data
            )

            response_200.append(componentsschemas_paginated_azure_public_ip_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[AzurePublicIpsListFieldItem]]):
        ...
        state (Union[Unset, list[AzurePublicIpsListStateItem]]):
