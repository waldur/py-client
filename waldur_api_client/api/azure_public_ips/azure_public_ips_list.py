...
from ...models.azure_public_ip_field_enum import AzurePublicIPFieldEnum
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[AzurePublicIPFieldEnum]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[AzurePublicIPFieldEnum]]):
