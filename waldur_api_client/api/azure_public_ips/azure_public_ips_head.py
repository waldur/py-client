...
from ...models.azure_public_ips_head_state_item import AzurePublicIpsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzurePublicIpsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzurePublicIpsHeadStateItem]]):
