...
from ...models.offering_user_posix_allocation import OfferingUserPosixAllocation
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-offering-users/{uuid}/posix_allocations/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["OfferingUserPosixAllocation"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = OfferingUserPosixAllocation.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["OfferingUserPosixAllocation"]]:
    return Response(
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['OfferingUserPosixAllocation']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[OfferingUserPosixAllocation] = []
