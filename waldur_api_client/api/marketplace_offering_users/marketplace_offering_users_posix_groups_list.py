...
from ...models.offering_user_posix_group import OfferingUserPosixGroup
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-offering-users/{uuid}/posix_groups/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = OfferingUserPosixGroup.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["OfferingUserPosixGroup"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List project group GIDs an offering user belongs to
     ...
     Returns the project group GIDs (shared GIDs that appear in the user's GLAuth otherGroups) for this
    offering user.
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['OfferingUserPosixGroup']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[OfferingUserPosixGroup] = []
