...
from ...models.offering_user_service_provider_comment import OfferingUserServiceProviderComment
from ...models.patched_offering_user_service_provider_comment_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/marketplace-offering-users/{uuid}/update_comments/",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = OfferingUserServiceProviderComment.from_dict(response.json())
