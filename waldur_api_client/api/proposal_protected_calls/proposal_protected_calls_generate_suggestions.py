...
from ...models.generate_suggestions_request_request import GenerateSuggestionsRequestRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/proposal-protected-calls/{uuid}/generate-suggestions/",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GenerateSuggestionsResponse.from_dict(response.json())
