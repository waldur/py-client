...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/proposal-protected-calls/{uuid}/proposed-assignments/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ProposedAssignment.from_dict(response_200_item_data)
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['ProposedAssignment']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ProposedAssignment] = []
