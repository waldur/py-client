...
from ...models.customer_credit_request import CustomerCreditRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/customer-credits/{uuid}/clear_compensations/",
    }

    if isinstance(body, CustomerCreditRequest):
