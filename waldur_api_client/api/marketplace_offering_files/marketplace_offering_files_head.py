...
from ...models.marketplace_offering_files_head_o_item import MarketplaceOfferingFilesHeadOItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    o: Union[Unset, list[MarketplaceOfferingFilesHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        o (Union[Unset, list[MarketplaceOfferingFilesHeadOItem]]):
