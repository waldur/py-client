...
from ...models.call_assignment_configuration_request import CallAssignmentConfigurationRequest
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = CallAssignmentConfiguration.from_dict(response.json())
