...
from ...models.marketplace_maintenance_announcement_template_offerings_head_o_item import (
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[MarketplaceMaintenanceAnnouncementTemplateOfferingsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceMaintenanceAnnouncementTemplateOfferingsHeadOItem]]):
