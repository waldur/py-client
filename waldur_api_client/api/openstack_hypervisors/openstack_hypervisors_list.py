...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> list["Hypervisor"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = Hypervisor.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    """
    Args:
        hypervisor_type (Union[Unset, str]):
...
def sync_all(
    *,
    ...
    Returns:
        list['Hypervisor']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[Hypervisor] = []
