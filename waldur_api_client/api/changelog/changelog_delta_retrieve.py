...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/changelog/{version}/delta/",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get changelog delta for a version

     Returns only the incremental changes since the previous version (since_previous entries).
