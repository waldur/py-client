...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-component-usages/{uuid}/",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> ComponentUsage:
    if response.status_code == 200:
        response_200 = ComponentUsage.from_dict(response.json())
