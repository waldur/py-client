...
from ...models.marketplace_project_update_requests_head_state_item import MarketplaceProjectUpdateRequestsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[MarketplaceProjectUpdateRequestsHeadStateItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[MarketplaceProjectUpdateRequestsHeadStateItem]]):
