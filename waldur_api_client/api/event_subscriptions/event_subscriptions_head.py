...
from ...models.event_subscriptions_head_o_item import EventSubscriptionsHeadOItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    o: Union[Unset, list[EventSubscriptionsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        o (Union[Unset, list[EventSubscriptionsHeadOItem]]):
