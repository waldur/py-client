...
from ...models.rancher_namespace import RancherNamespace
from ...models.rancher_namespaces_list_o_item import RancherNamespacesListOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[RancherNamespacesListOItem]] = UNSET,
...
) -> Optional[list["RancherNamespace"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_rancher_namespace_list_item_data in _response_200:
            componentsschemas_paginated_rancher_namespace_list_item = RancherNamespace.from_dict(
                componentsschemas_paginated_rancher_namespace_list_item_data
            )

            response_200.append(componentsschemas_paginated_rancher_namespace_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[RancherNamespacesListOItem]]):
