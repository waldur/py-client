...
from ...models.patched_open_stack_tenant_request import PatchedOpenStackTenantRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/openstack-tenants/{uuid}/",
    }

    if isinstance(body, PatchedOpenStackTenantRequest):
