...
from ...models.openstack_tenants_list_field_item import OpenstackTenantsListFieldItem
from ...models.openstack_tenants_list_state_item import OpenstackTenantsListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[OpenstackTenantsListFieldItem]] = UNSET,
...
) -> Optional[list["OpenStackTenant"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_tenant_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_tenant_list_item = OpenStackTenant.from_dict(
                componentsschemas_paginated_open_stack_tenant_list_item_data
            )

            response_200.append(componentsschemas_paginated_open_stack_tenant_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[OpenstackTenantsListFieldItem]]):
        ...
        state (Union[Unset, list[OpenstackTenantsListStateItem]]):
