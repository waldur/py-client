...
from ...models.openstack_tenants_head_state_item import OpenstackTenantsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackTenantsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackTenantsHeadStateItem]]):
