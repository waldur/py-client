...
from ...models.open_stack_backend_volumes import OpenStackBackendVolumes
from ...models.openstack_tenants_backend_volumes_list_state_item import OpenstackTenantsBackendVolumesListStateItem
...
def _get_kwargs(
    ...
    *,
    ...
    state: Union[Unset, list[OpenstackTenantsBackendVolumesListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/openstack-tenants/{uuid_path}/backend_volumes/",
        "params": params,
    }
...
) -> Optional[list["OpenStackBackendVolumes"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_backend_volumes_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_backend_volumes_list_item = OpenStackBackendVolumes.from_dict(
                componentsschemas_paginated_open_stack_backend_volumes_list_item_data
            )

            response_200.append(componentsschemas_paginated_open_stack_backend_volumes_list_item)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["OpenStackBackendVolumes"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackTenantsBackendVolumesListStateItem]]):
