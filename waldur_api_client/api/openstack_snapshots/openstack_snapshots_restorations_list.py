...
from ...models.openstack_snapshots_restorations_list_state_item import OpenstackSnapshotsRestorationsListStateItem
...
def _get_kwargs(
    ...
    *,
    ...
    state: Union[Unset, list[OpenstackSnapshotsRestorationsListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/openstack-snapshots/{uuid_path}/restorations/",
        "params": params,
    }
...
) -> Optional[list["OpenStackSnapshotRestoration"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_snapshot_restoration_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_snapshot_restoration_list_item = (
                OpenStackSnapshotRestoration.from_dict(
                    componentsschemas_paginated_open_stack_snapshot_restoration_list_item_data
                )
            )

            response_200.append(componentsschemas_paginated_open_stack_snapshot_restoration_list_item)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["OpenStackSnapshotRestoration"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSnapshotsRestorationsListStateItem]]):
...
def sync(
    ...
    *,
    ...
    Returns:
        list['OpenStackSnapshotRestoration']
    """
