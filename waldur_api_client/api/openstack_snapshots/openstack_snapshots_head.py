...
from ...models.openstack_snapshots_head_state_item import OpenstackSnapshotsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackSnapshotsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSnapshotsHeadStateItem]]):
