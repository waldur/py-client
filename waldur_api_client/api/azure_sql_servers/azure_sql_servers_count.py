...
from ...models.azure_sql_servers_count_state_item import AzureSqlServersCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzureSqlServersCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzureSqlServersCountStateItem]]):
