...
from ...models.azure_sql_servers_head_state_item import AzureSqlServersHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzureSqlServersHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzureSqlServersHeadStateItem]]):
