...
from ...models.azure_sql_database_create_response import AzureSqlDatabaseCreateResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = AzureSqlDatabaseCreateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[AzureSqlDatabaseCreateResponse]:
    return Response(
