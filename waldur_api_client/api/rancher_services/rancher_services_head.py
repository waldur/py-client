...
from ...models.rancher_services_head_state_item import RancherServicesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherServicesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherServicesHeadStateItem]]):
