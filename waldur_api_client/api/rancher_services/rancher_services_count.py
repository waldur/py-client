...
from ...models.rancher_services_count_state_item import RancherServicesCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherServicesCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherServicesCountStateItem]]):
