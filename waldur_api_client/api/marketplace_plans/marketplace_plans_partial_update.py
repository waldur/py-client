...
from ...models.patched_provider_plan_details_request import PatchedProviderPlanDetailsRequest
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> ProviderPlanDetails:
    ...
    if response.status_code == 200:
        response_200 = ProviderPlanDetails.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Partially update a provider plan
     ...
     Partially updates an existing plan. Note: A plan cannot be updated if it is already used by
    resources.
