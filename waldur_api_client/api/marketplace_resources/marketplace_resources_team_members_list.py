...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-resources/{uuid}/team_members/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ResourceTeamMember.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["ResourceTeamMember"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List team members of a resource
     ...
     One row per user (deduplicated) with their direct Resource role and a nested `resource_projects[]`
    array of their per-ResourceProject grants under this resource. Mirrors the org-level
    `customers/{uuid}/users/` shape so the frontend can render an expandable per-user view.
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['ResourceTeamMember']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ResourceTeamMember] = []
