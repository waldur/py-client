...
from ...models.marketplace_resources_history_at_retrieve_response_400 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-resources/{uuid}/history/at/",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = MarketplaceResourcesHistoryAtRetrieveResponse400.from_dict(response.json())

        return response_400
    if response.status_code == 404:
        response_404 = MarketplaceResourcesHistoryAtRetrieveResponse404.from_dict(response.json())
