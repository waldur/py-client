...
from ...models.maintenance_announcement_template_offerings_head_o_item import (
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[MaintenanceAnnouncementTemplateOfferingsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MaintenanceAnnouncementTemplateOfferingsHeadOItem]]):
