...
from ...models.openstack_backups_head_state_item import OpenstackBackupsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackBackupsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackBackupsHeadStateItem]]):
