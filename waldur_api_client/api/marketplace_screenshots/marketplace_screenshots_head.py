...
from ...models.marketplace_screenshots_head_o_item import MarketplaceScreenshotsHeadOItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    o: Union[Unset, list[MarketplaceScreenshotsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        o (Union[Unset, list[MarketplaceScreenshotsHeadOItem]]):
