...
from ...models.patched_offering_usage_policy_request import PatchedOfferingUsagePolicyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedOfferingUsagePolicyRequest):
