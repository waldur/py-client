...
from ...models.rancher_ingresses_yaml_retrieve_field_item import RancherIngressesYamlRetrieveFieldItem
...
def _get_kwargs(
    uuid: UUID,
    *,
    field: Union[Unset, list[RancherIngressesYamlRetrieveFieldItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (UUID):
        field (Union[Unset, list[RancherIngressesYamlRetrieveFieldItem]]):
