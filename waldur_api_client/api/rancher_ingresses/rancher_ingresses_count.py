...
from ...models.rancher_ingresses_count_state_item import RancherIngressesCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherIngressesCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherIngressesCountStateItem]]):
