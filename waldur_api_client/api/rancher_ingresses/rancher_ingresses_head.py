...
from ...models.rancher_ingresses_head_state_item import RancherIngressesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherIngressesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherIngressesHeadStateItem]]):
