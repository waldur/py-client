...
from ...models.keycloak_user_group_memberships_head_state_item import KeycloakUserGroupMembershipsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[KeycloakUserGroupMembershipsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[KeycloakUserGroupMembershipsHeadStateItem]]):
