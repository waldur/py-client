...
from ...models.marketplace_provider_offerings_list_project_service_accounts_list_o_item import (
    MarketplaceProviderOfferingsListProjectServiceAccountsListOItem,
)
from ...models.marketplace_provider_offerings_list_project_service_accounts_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsListProjectServiceAccountsListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderOfferingsListProjectServiceAccountsListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/list_project_service_accounts/",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """List project service accounts for an offering
     ...
     Returns a paginated list of project-level service accounts for projects that have resources of this
    offering.
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsListProjectServiceAccountsListOItem]]):
        ...
        state (Union[Unset,
            list[MarketplaceProviderOfferingsListProjectServiceAccountsListStateItem]]):
