...
from ...models.marketplace_provider_offerings_list_course_accounts_list_o_item import (
    MarketplaceProviderOfferingsListCourseAccountsListOItem,
)
from ...models.marketplace_provider_offerings_list_course_accounts_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsListCourseAccountsListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderOfferingsListCourseAccountsListStateItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsListCourseAccountsListOItem]]):
        ...
        state (Union[Unset, list[MarketplaceProviderOfferingsListCourseAccountsListStateItem]]):
