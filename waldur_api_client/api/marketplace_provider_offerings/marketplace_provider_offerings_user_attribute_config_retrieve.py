...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/user-attribute-config/",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get user attribute config
     ...
     Returns the user attribute configuration for this offering, which determines which user attributes
    are exposed to the service provider.
