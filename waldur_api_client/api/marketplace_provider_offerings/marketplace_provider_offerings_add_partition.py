...
from ...models.offering_partition_request import OfferingPartitionRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/marketplace-provider-offerings/{uuid}/add_partition/",
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> OfferingPartition:
    ...
    if response.status_code == 201:
        response_201 = OfferingPartition.from_dict(response.json())
