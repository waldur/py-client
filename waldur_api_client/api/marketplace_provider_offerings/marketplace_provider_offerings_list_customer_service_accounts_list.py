...
from ...models.marketplace_provider_offerings_list_customer_service_accounts_list_o_item import (
    MarketplaceProviderOfferingsListCustomerServiceAccountsListOItem,
)
from ...models.marketplace_provider_offerings_list_customer_service_accounts_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/list_customer_service_accounts/",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """List customer service accounts for an offering
     ...
     Returns a paginated list of customer-level service accounts for customers who have resources of this
    offering.
