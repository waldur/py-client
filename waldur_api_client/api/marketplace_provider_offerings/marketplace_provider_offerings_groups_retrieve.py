...
from ...models.marketplace_provider_offerings_groups_retrieve_field_item import (
...
def _get_kwargs(
    *,
    field: Union[Unset, list[MarketplaceProviderOfferingsGroupsRetrieveFieldItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    """
    Args:
        field (Union[Unset, list[MarketplaceProviderOfferingsGroupsRetrieveFieldItem]]):
