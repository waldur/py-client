...
from ...models.provider_offering_customer_field_enum import ProviderOfferingCustomerFieldEnum
...
def _get_kwargs(
    ...
    *,
    ...
    field: Union[Unset, list[ProviderOfferingCustomerFieldEnum]] = UNSET,
    ...
    json_offering_group_uuid: Union[Unset, str] = UNSET
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ProviderOfferingCustomer.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[ProviderOfferingCustomerFieldEnum]]):
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['ProviderOfferingCustomer']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ProviderOfferingCustomer] = []
