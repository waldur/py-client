...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/marketplace-provider-offerings/{uuid}/sync_resources/",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Synchronize offering resources
     ...
     Requests connected site agents to run a full reconciliation of all resources belonging to this
    offering: recreate missing backend accounts, restore user associations and re-apply resource limits.
