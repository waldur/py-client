...
from ...models.marketplace_provider_offerings_list_customer_users_list_o_item import (
    MarketplaceProviderOfferingsListCustomerUsersListOItem,
)
from ...models.marketplace_provider_offerings_list_customer_users_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsListCustomerUsersListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderOfferingsListCustomerUsersListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/list_customer_users/",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsListCustomerUsersListOItem]]):
        ...
        state (Union[Unset, list[MarketplaceProviderOfferingsListCustomerUsersListStateItem]]):
