...
from ...models.maintenance_announcements_template_head_o_item import MaintenanceAnnouncementsTemplateHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[MaintenanceAnnouncementsTemplateHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MaintenanceAnnouncementsTemplateHeadOItem]]):
