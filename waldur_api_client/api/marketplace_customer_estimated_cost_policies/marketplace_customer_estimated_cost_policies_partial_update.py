...
from ...models.patched_customer_estimated_cost_policy_request import PatchedCustomerEstimatedCostPolicyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedCustomerEstimatedCostPolicyRequest):
...
) -> Optional[CustomerEstimatedCostPolicy]:
