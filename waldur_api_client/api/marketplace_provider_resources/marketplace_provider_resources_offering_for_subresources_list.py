...
from ...models.marketplace_provider_resources_offering_for_subresources_list_o_item import (
    MarketplaceProviderResourcesOfferingForSubresourcesListOItem,
)
from ...models.marketplace_provider_resources_offering_for_subresources_list_state_item import (
    MarketplaceProviderResourcesOfferingForSubresourcesListStateItem,
)
from ...models.subresource_offering import SubresourceOffering
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderResourcesOfferingForSubresourcesListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderResourcesOfferingForSubresourcesListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-resources/{uuid}/offering_for_subresources/",
        "params": params,
    }
...
) -> Optional[list["SubresourceOffering"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = SubresourceOffering.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderResourcesOfferingForSubresourcesListOItem]]):
        ...
        state (Union[Unset,
            list[MarketplaceProviderResourcesOfferingForSubresourcesListStateItem]]):
