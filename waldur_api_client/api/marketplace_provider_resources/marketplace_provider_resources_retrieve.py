...
from ...models.marketplace_provider_resources_retrieve_field_item import MarketplaceProviderResourcesRetrieveFieldItem
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-resources/{uuid}/",
        "params": params,
    }
