...
from ...models.marketplace_provider_resources_set_paused_response_200 import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MarketplaceProviderResourcesSetPausedResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[MarketplaceProviderResourcesSetPausedResponse200]:
    return Response(
