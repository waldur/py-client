...
from ...models.vmware_disk_field_enum import VmwareDiskFieldEnum
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[VmwareDiskFieldEnum]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[VmwareDiskFieldEnum]]):
