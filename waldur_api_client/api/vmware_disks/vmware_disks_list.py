...
from ...models.vmware_disks_list_field_item import VmwareDisksListFieldItem
from ...models.vmware_disks_list_state_item import VmwareDisksListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[VmwareDisksListFieldItem]] = UNSET,
    ...
    state: Union[Unset, list[VmwareDisksListStateItem]] = UNSET,
...
) -> Optional[list["VmwareDisk"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_vmware_disk_list_item_data in _response_200:
            componentsschemas_paginated_vmware_disk_list_item = VmwareDisk.from_dict(
                componentsschemas_paginated_vmware_disk_list_item_data
            )

            response_200.append(componentsschemas_paginated_vmware_disk_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[VmwareDisksListFieldItem]]):
        ...
        state (Union[Unset, list[VmwareDisksListStateItem]]):
