...
from ...models.vmware_disks_head_state_item import VmwareDisksHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[VmwareDisksHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[VmwareDisksHeadStateItem]]):
