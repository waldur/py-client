...
from ...models.user_requested_resource import UserRequestedResource
...
def _get_kwargs(
    *,
    ...
    include_closed: Union[Unset, bool] = UNSET,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = UserRequestedResource.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["UserRequestedResource"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        include_closed (Union[Unset, bool]):
...
def sync_all(
    *,
    ...
    Returns:
        list['UserRequestedResource']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[UserRequestedResource] = []
