...
from ...models.openstack_security_groups_list_field_item import OpenstackSecurityGroupsListFieldItem
from ...models.openstack_security_groups_list_state_item import OpenstackSecurityGroupsListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[OpenstackSecurityGroupsListFieldItem]] = UNSET,
    ...
    state: Union[Unset, list[OpenstackSecurityGroupsListStateItem]] = UNSET,
...
) -> Optional[list["OpenStackSecurityGroup"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_open_stack_security_group_list_item_data in _response_200:
            componentsschemas_paginated_open_stack_security_group_list_item = OpenStackSecurityGroup.from_dict(
                componentsschemas_paginated_open_stack_security_group_list_item_data
            )

            response_200.append(componentsschemas_paginated_open_stack_security_group_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[OpenstackSecurityGroupsListFieldItem]]):
        ...
        state (Union[Unset, list[OpenstackSecurityGroupsListStateItem]]):
