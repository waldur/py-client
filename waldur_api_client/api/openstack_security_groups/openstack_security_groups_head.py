...
from ...models.openstack_security_groups_head_state_item import OpenstackSecurityGroupsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackSecurityGroupsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSecurityGroupsHeadStateItem]]):
