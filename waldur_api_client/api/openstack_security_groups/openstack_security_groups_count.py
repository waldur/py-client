...
from ...models.openstack_security_groups_count_state_item import OpenstackSecurityGroupsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackSecurityGroupsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackSecurityGroupsCountStateItem]]):
