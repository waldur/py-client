...
from ...models.rancher_clusters_head_state_item import RancherClustersHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherClustersHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherClustersHeadStateItem]]):
