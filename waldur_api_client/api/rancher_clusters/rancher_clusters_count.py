...
from ...models.rancher_clusters_count_state_item import RancherClustersCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[RancherClustersCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[RancherClustersCountStateItem]]):
