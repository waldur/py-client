...
from ...models.rancher_cluster_field_enum import RancherClusterFieldEnum
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[RancherClusterFieldEnum]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[RancherClusterFieldEnum]]):
