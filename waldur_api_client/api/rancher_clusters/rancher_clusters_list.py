...
from ...models.rancher_clusters_list_field_item import RancherClustersListFieldItem
from ...models.rancher_clusters_list_state_item import RancherClustersListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[RancherClustersListFieldItem]] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemas_paginated_rancher_cluster_list_item_data in _response_200:
            componentsschemas_paginated_rancher_cluster_list_item = RancherCluster.from_dict(
                componentsschemas_paginated_rancher_cluster_list_item_data
            )

            response_200.append(componentsschemas_paginated_rancher_cluster_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[RancherClustersListFieldItem]]):
        ...
        state (Union[Unset, list[RancherClustersListStateItem]]):
