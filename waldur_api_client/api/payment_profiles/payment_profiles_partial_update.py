...
from ...models.patched_payment_profile_request import PatchedPaymentProfileRequest
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> PaymentProfile:
