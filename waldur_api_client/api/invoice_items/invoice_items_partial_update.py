...
from ...models.patched_invoice_item_update_request import PatchedInvoiceItemUpdateRequest
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> InvoiceItemUpdate:
