...
from ...models.customer_credit_consumption_by_month import CustomerCreditConsumptionByMonth
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/invoice-items/{uuid}/consumptions/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["CustomerCreditConsumptionByMonth"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = CustomerCreditConsumptionByMonth.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["CustomerCreditConsumptionByMonth"]]:
    return Response(
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['CustomerCreditConsumptionByMonth']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[CustomerCreditConsumptionByMonth] = []
