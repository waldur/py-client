...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/proposal-proposals/{uuid}/workflow_states/",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["ProposalWorkflowStepInstance"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ProposalWorkflowStepInstance.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["ProposalWorkflowStepInstance"]]:
    return Response(
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['ProposalWorkflowStepInstance']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ProposalWorkflowStepInstance] = []
