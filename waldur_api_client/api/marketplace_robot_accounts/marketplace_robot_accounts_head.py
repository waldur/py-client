...
from ...models.marketplace_robot_accounts_head_state import MarketplaceRobotAccountsHeadState
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, MarketplaceRobotAccountsHeadState] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, MarketplaceRobotAccountsHeadState]):
