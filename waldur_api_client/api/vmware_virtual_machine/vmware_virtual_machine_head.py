...
from ...models.vmware_virtual_machine_head_state_item import VmwareVirtualMachineHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[VmwareVirtualMachineHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[VmwareVirtualMachineHeadStateItem]]):
