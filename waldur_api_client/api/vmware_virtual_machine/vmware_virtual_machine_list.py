...
from ...models.vmware_virtual_machine_list_field_item import VmwareVirtualMachineListFieldItem
from ...models.vmware_virtual_machine_list_state_item import VmwareVirtualMachineListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[VmwareVirtualMachineListFieldItem]] = UNSET,
...
) -> Optional[list["VmwareVirtualMachine"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_vmware_virtual_machine_list_item_data in _response_200:
            componentsschemas_paginated_vmware_virtual_machine_list_item = VmwareVirtualMachine.from_dict(
                componentsschemas_paginated_vmware_virtual_machine_list_item_data
            )

            response_200.append(componentsschemas_paginated_vmware_virtual_machine_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[VmwareVirtualMachineListFieldItem]]):
        ...
        state (Union[Unset, list[VmwareVirtualMachineListStateItem]]):
