...
from ...models.vmware_virtual_machine_field_enum import VmwareVirtualMachineFieldEnum
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[VmwareVirtualMachineFieldEnum]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[VmwareVirtualMachineFieldEnum]]):
