...
from ...models.resource_limit_change_request_request import ResourceLimitChangeRequestRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/marketplace-resource-limit-change-requests/{uuid}/cancel/",
    }
