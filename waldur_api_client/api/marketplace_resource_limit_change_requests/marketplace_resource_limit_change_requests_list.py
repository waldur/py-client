...
from ...models.resource_limit_change_request import ResourceLimitChangeRequest
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["ResourceLimitChangeRequest"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ResourceLimitChangeRequest.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["ResourceLimitChangeRequest"]]:
    return Response(
...
def sync_all(
    *,
    ...
    Returns:
        list['ResourceLimitChangeRequest']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ResourceLimitChangeRequest] = []
