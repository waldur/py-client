...
from ...models.user_agreements_head_agreement_type import UserAgreementsHeadAgreementType
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    agreement_type: Union[Unset, UserAgreementsHeadAgreementType] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        agreement_type (Union[Unset, UserAgreementsHeadAgreementType]):
