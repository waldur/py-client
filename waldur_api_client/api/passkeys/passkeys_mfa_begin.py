...
from ...models.passkey_mfa_begin_request import PasskeyMfaBeginRequest
from ...types import Response


def _get_kwargs(
    *,
    body: PasskeyMfaBeginRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/passkeys/mfa/begin/",
    }
...
def sync_detailed(
    *,
    ...
    """Begin the passkey second factor
