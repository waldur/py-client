...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/chat-messages/{uuid}/history/",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> list["Message"]:
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['Message']: Combined results from all pages
    """
