...
from ...models.vmware_ports_count_state_item import VmwarePortsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[VmwarePortsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[VmwarePortsCountStateItem]]):
