...
from ...models.call_managing_organisations_head_o_item import CallManagingOrganisationsHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[CallManagingOrganisationsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[CallManagingOrganisationsHeadOItem]]):
