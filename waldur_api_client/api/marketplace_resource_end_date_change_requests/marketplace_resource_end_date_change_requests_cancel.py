...
from ...models.resource_end_date_change_request_request import ResourceEndDateChangeRequestRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/marketplace-resource-end-date-change-requests/{uuid}/cancel/",
    }
