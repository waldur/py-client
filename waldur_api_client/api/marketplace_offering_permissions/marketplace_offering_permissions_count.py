...
from ...models.marketplace_offering_permissions_count_o_item import MarketplaceOfferingPermissionsCountOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[MarketplaceOfferingPermissionsCountOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceOfferingPermissionsCountOItem]]):
