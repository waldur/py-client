...
from ...models.support_issues_head_o_item import SupportIssuesHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[SupportIssuesHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        key (Union[Unset, str]):
        o (Union[Unset, list[SupportIssuesHeadOItem]]):
