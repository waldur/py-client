...
from ...models.openstack_marketplace_tenants_head_state_item import OpenstackMarketplaceTenantsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackMarketplaceTenantsHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackMarketplaceTenantsHeadStateItem]]):
