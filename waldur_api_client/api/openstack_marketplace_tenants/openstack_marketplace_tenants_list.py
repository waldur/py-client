...
from ...models.openstack_marketplace_tenants_list_state_item import OpenstackMarketplaceTenantsListStateItem
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> list["Tenant"]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackMarketplaceTenantsListStateItem]]):
...
def sync_all(
    *,
    ...
    Returns:
        list['Tenant']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[Tenant] = []
