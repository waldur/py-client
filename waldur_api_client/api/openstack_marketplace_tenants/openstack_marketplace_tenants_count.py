...
from ...models.openstack_marketplace_tenants_count_state_item import OpenstackMarketplaceTenantsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackMarketplaceTenantsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackMarketplaceTenantsCountStateItem]]):
