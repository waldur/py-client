...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> list["ProjectQuotas"]:
...
def sync_all(
    *,
    ...
    Returns:
        list['ProjectQuotas']: Combined results from all pages
    """
