...
from ...models.openportal_unmanaged_projects_retrieve_field_item import OpenportalUnmanagedProjectsRetrieveFieldItem
...
def _get_kwargs(
    uuid: UUID,
    *,
    field: Union[Unset, list[OpenportalUnmanagedProjectsRetrieveFieldItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (UUID):
        field (Union[Unset, list[OpenportalUnmanagedProjectsRetrieveFieldItem]]):
