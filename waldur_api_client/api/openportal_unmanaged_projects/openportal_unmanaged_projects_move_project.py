...
from ...models.openportal_unmanaged_projects_move_project_response_400 import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Union[OpenportalUnmanagedProjectsMoveProjectResponse400, Project]:
    ...
    if response.status_code == 400:
        response_400 = OpenportalUnmanagedProjectsMoveProjectResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OpenportalUnmanagedProjectsMoveProjectResponse400, Project]]:
    return Response(
