...
from ...models.azure_virtualmachines_head_state_item import AzureVirtualmachinesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AzureVirtualmachinesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AzureVirtualmachinesHeadStateItem]]):
