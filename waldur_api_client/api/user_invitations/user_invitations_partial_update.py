...
from ...models.patched_invitation_update_request import PatchedInvitationUpdateRequest
...
def _get_kwargs(
    uuid: UUID,
    *,
    body: PatchedInvitationUpdateRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Partially update user invitation
     ...
     Partially update an existing user invitation. Only pending invitations can be edited. Allows
    changing email and role within the same scope.
