    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> list["RemoteProjectAllocationEntry"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = RemoteProjectAllocationEntry.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["RemoteProjectAllocationEntry"]]:
    return Response(
...
def sync_all(
    *,
    ...
    Returns:
        list['RemoteProjectAllocationEntry']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[RemoteProjectAllocationEntry] = []
