...
from ...models.open_stack_pool_field_enum import OpenStackPoolFieldEnum
...
def _get_kwargs(
    *,
    field: Union[Unset, list[OpenStackPoolFieldEnum]] = UNSET,
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> list["OpenStackPool"]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = OpenStackPool.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        field (Union[Unset, list[OpenStackPoolFieldEnum]]):
...
def sync_all(
    *,
    ...
    Returns:
        list['OpenStackPool']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[OpenStackPool] = []
