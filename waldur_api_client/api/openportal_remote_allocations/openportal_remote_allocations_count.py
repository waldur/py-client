...
from ...models.openportal_remote_allocations_count_state_item import OpenportalRemoteAllocationsCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenportalRemoteAllocationsCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenportalRemoteAllocationsCountStateItem]]):
