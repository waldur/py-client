...
from ...models.aws_instances_count_state_item import AwsInstancesCountStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AwsInstancesCountStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AwsInstancesCountStateItem]]):
