...
from ...models.aws_instances_head_state_item import AwsInstancesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[AwsInstancesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[AwsInstancesHeadStateItem]]):
