...
from ...models.aws_instances_list_field_item import AwsInstancesListFieldItem
from ...models.aws_instances_list_state_item import AwsInstancesListStateItem
...
def _get_kwargs(
    *,
    ...
    field: Union[Unset, list[AwsInstancesListFieldItem]] = UNSET,
...
) -> Optional[list["AwsInstance"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_aws_instance_list_item_data in _response_200:
            componentsschemas_paginated_aws_instance_list_item = AwsInstance.from_dict(
                componentsschemas_paginated_aws_instance_list_item_data
            )

            response_200.append(componentsschemas_paginated_aws_instance_list_item)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[AwsInstancesListFieldItem]]):
        ...
        state (Union[Unset, list[AwsInstancesListStateItem]]):
