...
from ...models.rancher_workloads_head_o_item import RancherWorkloadsHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[RancherWorkloadsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[RancherWorkloadsHeadOItem]]):
