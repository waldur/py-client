...
from ...models.marketplace_provider_offerings_list_customer_projects_list_o_item import (
    MarketplaceProviderOfferingsListCustomerProjectsListOItem,
)
from ...models.marketplace_provider_offerings_list_customer_projects_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsListCustomerProjectsListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderOfferingsListCustomerProjectsListStateItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsListCustomerProjectsListOItem]]):
        ...
        state (Union[Unset, list[MarketplaceProviderOfferingsListCustomerProjectsListStateItem]]):
