...
from ...models.marketplace_provider_offerings_costs_list_o_item import MarketplaceProviderOfferingsCostsListOItem
from ...models.marketplace_provider_offerings_costs_list_state_item import (
    MarketplaceProviderOfferingsCostsListStateItem,
)
from ...models.provider_offering_costs import ProviderOfferingCosts
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/costs/",
        "params": params,
    }
...
) -> Optional[list["ProviderOfferingCosts"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_provider_offering_costs_list_item_data in _response_200:
            componentsschemas_paginated_provider_offering_costs_list_item = ProviderOfferingCosts.from_dict(
                componentsschemas_paginated_provider_offering_costs_list_item_data
            )

            response_200.append(componentsschemas_paginated_provider_offering_costs_list_item)
