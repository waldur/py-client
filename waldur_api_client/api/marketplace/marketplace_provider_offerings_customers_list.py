...
from ...models.marketplace_provider_offerings_customers_list_state_item import (
    MarketplaceProviderOfferingsCustomersListStateItem,
)
from ...models.provider_offering_customer import ProviderOfferingCustomer
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsCustomersListOItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/customers/",
        "params": params,
    }
...
) -> Optional[list["ProviderOfferingCustomer"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_provider_offering_customer_list_item_data in _response_200:
            componentsschemas_paginated_provider_offering_customer_list_item = ProviderOfferingCustomer.from_dict(
                componentsschemas_paginated_provider_offering_customer_list_item_data
            )

            response_200.append(componentsschemas_paginated_provider_offering_customer_list_item)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsCustomersListOItem]]):
