...
from ...models.importable_resource import ImportableResource
from ...models.marketplace_provider_offerings_importable_resources_list_o_item import (
    MarketplaceProviderOfferingsImportableResourcesListOItem,
)
from ...models.marketplace_provider_offerings_importable_resources_list_state_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    o: Union[Unset, list[MarketplaceProviderOfferingsImportableResourcesListOItem]] = UNSET,
    ...
    state: Union[Unset, list[MarketplaceProviderOfferingsImportableResourcesListStateItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/marketplace-provider-offerings/{uuid}/importable_resources/",
        "params": params,
    }
...
) -> Optional[list["ImportableResource"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_importable_resource_list_item_data in _response_200:
            componentsschemas_paginated_importable_resource_list_item = ImportableResource.from_dict(
                componentsschemas_paginated_importable_resource_list_item_data
            )

            response_200.append(componentsschemas_paginated_importable_resource_list_item)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MarketplaceProviderOfferingsImportableResourcesListOItem]]):
        ...
        state (Union[Unset, list[MarketplaceProviderOfferingsImportableResourcesListStateItem]]):
