...
from ...models.openstack_flavors_head_o_item import OpenstackFlavorsHeadOItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[OpenstackFlavorsHeadOItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[OpenstackFlavorsHeadOItem]]):
