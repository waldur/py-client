...
from ...models.openstack_volumes_head_state_item import OpenstackVolumesHeadStateItem
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, list[OpenstackVolumesHeadStateItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        state (Union[Unset, list[OpenstackVolumesHeadStateItem]]):
