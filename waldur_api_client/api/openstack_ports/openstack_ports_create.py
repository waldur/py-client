...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[OpenStackPort]:
    if response.status_code == 201:
        response_201 = OpenStackPort.from_dict(response.json())
