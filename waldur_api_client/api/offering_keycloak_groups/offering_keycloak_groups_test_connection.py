...
from ...models.offering_uuid_request import OfferingUUIDRequest
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> TestConnectionResponse:
