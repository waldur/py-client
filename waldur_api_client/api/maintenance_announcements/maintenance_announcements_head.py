...
from ...models.maintenance_announcements_head_o_item import MaintenanceAnnouncementsHeadOItem
from ...models.maintenance_announcements_head_state_item import MaintenanceAnnouncementsHeadStateItem
...
def _get_kwargs(
    *,
    ...
    o: Union[Unset, list[MaintenanceAnnouncementsHeadOItem]] = UNSET,
    ...
    state: Union[Unset, list[MaintenanceAnnouncementsHeadStateItem]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        o (Union[Unset, list[MaintenanceAnnouncementsHeadOItem]]):
        ...
        state (Union[Unset, list[MaintenanceAnnouncementsHeadStateItem]]):
