...
from ...models.marketplace_service_provider_user_field_enum import MarketplaceServiceProviderUserFieldEnum
...
def _get_kwargs(
    ...
    *,
    ...
    field: Union[Unset, list[MarketplaceServiceProviderUserFieldEnum]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """List users of a service provider
     ...
     Returns a paginated list of all users who have consumed resources from the specified service
    provider.
    ...
    Args:
        ...
        field (Union[Unset, list[MarketplaceServiceProviderUserFieldEnum]]):
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['MarketplaceServiceProviderUser']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[MarketplaceServiceProviderUser] = []
