...
from ...models.provider_offering_field_enum import ProviderOfferingFieldEnum
...
def _get_kwargs(
    ...
    *,
    ...
    field: Union[Unset, list[ProviderOfferingFieldEnum]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        field (Union[Unset, list[ProviderOfferingFieldEnum]]):
...
def sync_all(
    ...
    *,
    ...
    Returns:
        list['ProviderOffering']: Combined results from all pages
    """
    from urllib.parse import parse_qs, urlparse

    all_results: list[ProviderOffering] = []
