...
from ...models.set_token_quota_request import SetTokenQuotaRequest
...
def sync_detailed(
    *,
    ...
    """Set token quota for user
     ...
     Allows staff/support to set token quota limits for a specific user. Configure daily, weekly, and
    monthly limits:
