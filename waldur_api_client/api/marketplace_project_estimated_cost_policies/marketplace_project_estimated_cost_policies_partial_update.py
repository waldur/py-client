...
from ...models.patched_project_estimated_cost_policy_request import PatchedProjectEstimatedCostPolicyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedProjectEstimatedCostPolicyRequest):
